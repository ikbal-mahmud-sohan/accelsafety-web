...
<template>
  ...
  >
    ...
    <div class="mt-[4.7rem] flex md:mt-0">
      ...
      <!-- BEGIN: Content -->
      <div
        class="md:max-w-auto min-w-0 max-w-full flex-1 rounded-[30px] bg-slate-100 px-4 pb-10 before:block before:h-px before:w-full before:content-[''] dark:bg-darkmode-700 md:px-[22px]"
      >
        <TopBar />
        <RouterView />
      </div>
