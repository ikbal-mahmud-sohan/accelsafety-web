...
const deleteRespDepartment = async (sID:string) => {
  console.log("sID",sID)
...
onMounted(() => {
  fetchRespDepartmentData();
  fetchOwnerDepartmentData();
  fetchPlantNameData();
});
</script>
    ...
    <div class="col-span-11 intro-y 2xl:col-span-9">
      ...
      <div class="p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400 flex flex-wrap" >
          <ul v-for="(data, index) in state.respDepartment" :key="index" class="">
            <li class="p-2">
              <span class=" inline-block px-4 py-3 bg-gray-100 rounded-sm min-w-52 md:min-w-36 text-center"> 
              {{data.name}}
              <a class="ml-2"  href="javascript:;" @click="deleteRespDepartment(data.id)">×</a>
              </span>
            </li>
          </ul>
        </div>
      ...
      <div class="p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400 flex flex-wrap" >
          <ul v-for="(data, index) in state.ownerDepartment " :key="index" class="">
            <li class="p-2">
              <span class=" inline-block px-4 py-3 bg-gray-100 rounded-sm min-w-52 md:min-w-36 text-center"> 
              {{data.name}}
              <a class="ml-2"  href="javascript:;" @click="deleteOwnerDepartment(data.id)">×</a>
              </span>
            </li>
          </ul>
        </div>
      ...
      <div class="p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400 flex flex-wrap" >
          <ul v-for="(data, index) in state.plantName " :key="index" class="">
            <li class="p-2">
              <span class=" inline-block px-4 py-3 bg-gray-100 rounded-sm min-w-52 md:min-w-36 text-center"> 
              {{data.name}}
              <a class="ml-2"  href="javascript:;" @click="deletePlantName(data.id)">×</a>
              </span>
            </li>
          </ul>
        </div>
