...
const fetchData = async () => {
  try {
    ...
    formData.serial_number = response.data.data.serial_number
    formData.training_topic = response.data.data.training_topic
    formData.iso_standard = response.data.data.iso_standard
    formData.venue = response.data.data.venue
    formData.facilitator = response.data.data.facilitator
    formData.training_date = response.data.data.training_date
    formData.training_duration = response.data.data.training_duration
    formData.name = response.data.data.name
    formData.title = response.data.data.title
    formData.function = response.data.data.function
    formData.business = response.data.data.business
    formData.signature = response.data.data.signature
  } catch (error) {
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Training Attendence Update Form</h2>
  </div>
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Training Attendence Update success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Training Attendence Update failed!</div>
