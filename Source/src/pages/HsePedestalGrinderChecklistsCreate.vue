...
const submitForm = async () => {
   formData.pedestal_grinder_des_1 = 'Physical condition of body should be good & sound';
   formData.pedestal_grinder_des_2 = 'On/off switch should be in proper condition';
   formData.pedestal_grinder_des_3 = 'Wheel guard should be in good condition';
   formData.pedestal_grinder_des_4 = 'Tool rest should be available at distance of 3 mm from rotating wheel';
   formData.pedestal_grinder_des_5 = 'Eye guard and spark deflector should be available';
   formData.pedestal_grinder_des_6 = 'Machine should be double insulated or grounded';
   formData.pedestal_grinder_des_7 = 'Wheel should free from defect and rotating capacity should be marked';
   formData.pedestal_grinder_des_8 = 'Power cable should be free from damage and connection taken through industrial plug';
   formData.pedestal_grinder_des_9 = 'Always use designated key for changing wheel';
   formData.pedestal_grinder_des_10 = 'Machine operated by competent person';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_pedestal_grinder_1 = ishvcomplied1.value;
  formData.is_pedestal_grinder_2 = ishvcomplied2.value;
  formData.is_pedestal_grinder_3 = ishvcomplied3.value;
  formData.is_pedestal_grinder_4 = ishvcomplied4.value;
  formData.is_pedestal_grinder_5 = ishvcomplied5.value;
  formData.is_pedestal_grinder_6 = ishvcomplied6.value;
  formData.is_pedestal_grinder_7 = ishvcomplied7.value;
  formData.is_pedestal_grinder_8 = ishvcomplied8.value;
  formData.is_pedestal_grinder_9 = ishvcomplied9.value;
  formData.is_pedestal_grinder_10 = ishvcomplied10.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/pedestal-grinder-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'pedestal-grinder-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Pedestal Grinder</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Pedestal Grinder
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_1" class="w-full" type="text" name="pedestal_grinder_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">On/off switch should be in proper condition</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_2" class="w-full" type="text" name="pedestal_grinder_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Wheel guard should be in good condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_3" class="w-full" type="text" name="pedestal_grinder_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Tool rest should be available at distance of 3 mm from rotating wheel</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_4" class="w-full" type="text" name="pedestal_grinder_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Eye guard and spark deflector should be available</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_5" class="w-full" type="text" name="pedestal_grinder_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Machine should be double insulated or grounded</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_6" class="w-full" type="text" name="pedestal_grinder_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Wheel should free from defect and rotating capacity should be marked</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_7" class="w-full" type="text" name="pedestal_grinder_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Power cable should be free from damage and connection taken through industrial plug</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_8" class="w-full" type="text" name="pedestal_grinder_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Always use designated key for changing wheel</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_9" class="w-full" type="text" name="pedestal_grinder_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.pedestal_grinder_remarks_10" class="w-full" type="text" name="pedestal_grinder_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/BenchCuttingMachine.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Pedestal Grinder report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Pedestal Grinder success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Pedestal Grinder failed!</div>
