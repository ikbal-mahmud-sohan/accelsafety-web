...
const rules = {
        ...
        fire_extinguisher_ton_id:{required,},
...
const submitForm = async () => {
    ...
    let sID =id.toString()
    formData.fire_extinguisher_ton_id = sID;
...
const deleteData = async (sID:string) => {
  try {
    let url = config.baseURL+"/api/v1/fire-extinguisher-ton-checklist/delete/"+sID;
...
const fetchDataById = async () => {
  try {
    ...
    const url = `${config.baseURL}/api/v1/fire-extinguisher-ton/edit/${id}`;
    const response = await axios.get(url, {
      headers: {
        Authorization: state.token,
      },
...
<template>
  <div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="col-span-12 overflow-y-auto ">
        <div class="risk-form-head">
          <div class="py-4 bg-theme-1">
              <p class=" text-base font-semibold uppercase text-center text-white">Fire Extinguisher TON FORM</p>
          </div>
   ...
   <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium text-nowrap">Fire Extinguisher TON Checklist Create success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium text-nowrap">Fire Extinguisher TON Checklist Create failed!</div>
