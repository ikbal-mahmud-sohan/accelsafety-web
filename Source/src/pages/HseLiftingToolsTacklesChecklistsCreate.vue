...
const submitForm = async () => {
   formData.lifting_tools_des_1 = 'Wire sling should be free from defects, e.g., corrosion, crack, cuts & oily, etc.';
   formData.lifting_tools_des_2 = 'Use thimble for making I-shape';
   formData.lifting_tools_des_3 = 'Wire rope should be knotted with proper clamp';
   formData.lifting_tools_des_4 = 'Web sling should be free from defects, e.g., cuts, abrasion, knot, hole & oily, etc.';
   formData.lifting_tools_des_5 = 'I-shape should be free from damages';
   formData.lifting_tools_des_6 = 'D-shackle should be in good condition and its face should not expand more than 15% of its original shape.';
   formData.lifting_tools_des_7 = 'Suitable I-bolt should be used';
   formData.lifting_tools_des_8 = 'Lifting tools & tackles should be used having suitable strength & capacity';
   formData.lifting_tools_des_9 = 'Lifting tools & tackles should be handle and store in safe manner';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_lifting_tools_1 = ishvcomplied1.value;
  formData.is_lifting_tools_2 = ishvcomplied2.value;
  formData.is_lifting_tools_3 = ishvcomplied3.value;
  formData.is_lifting_tools_4 = ishvcomplied4.value;
  formData.is_lifting_tools_5 = ishvcomplied5.value;
  formData.is_lifting_tools_6 = ishvcomplied6.value;
  formData.is_lifting_tools_7 = ishvcomplied7.value;
  formData.is_lifting_tools_8 = ishvcomplied8.value;
  formData.is_lifting_tools_9 = ishvcomplied9.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/lifting-tools-tackles-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'lifting-tools-tackles-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Lifting Tools Tackles</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Lifting Tools Tackles
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Wire sling should be free from defects, e.g., corrosion, crack, cuts & oily, etc.
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_1" class="w-full" type="text" name="lifting_tools_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Use thimble for making I-shape</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_2" class="w-full" type="text" name="lifting_tools_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Wire rope should be knotted with proper clamp</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_3" class="w-full" type="text" name="lifting_tools_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Web sling should be free from defects, e.g., cuts, abrasion, knot, hole & oily, etc.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_4" class="w-full" type="text" name="lifting_tools_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">I-shape should be free from damages</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_5" class="w-full" type="text" name="lifting_tools_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">D-shackle should be in good condition and its face should not expand more than 15% of its original shape.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_6" class="w-full" type="text" name="lifting_tools_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Suitable I-bolt should be used</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_7" class="w-full" type="text" name="lifting_tools_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Lifting tools & tackles should be used having suitable strength & capacity</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_8" class="w-full" type="text" name="lifting_tools_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Lifting tools & tackles should be handle and store in safe manner</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.lifting_tools_remarks_9" class="w-full" type="text" name="lifting_tools_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div>  
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/LiftingToolsTackles.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <a href="">Lifting Tools Tackles</a>
          </li>
          <li
        ...
        >
          ...
          >
            <div>
              When filling out the Lifting Tools Tackles report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Lifting Tools Tackles success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Lifting Tools Tackles failed!</div>
