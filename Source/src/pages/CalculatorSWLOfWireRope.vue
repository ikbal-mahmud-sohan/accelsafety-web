...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Calculate SWL of Wire Rope</h2>
  </div>
  <div class="grid grid-cols-11 pb-20 mt-5 gap-x-6">
    ...
    >
      <div class="flex items-center">
        ...
        <span>
          Note: This calculator is for educational purposes only. Always follow manufacturer guidelines for accurate SWL of Wire Rope calculation.
          <a
              ...
              <FormLabel class="xl:w-64 xl:!mr-10">
                <div class="text-left">
                  <div class="flex items-center pr-4">
                    <div class="font-medium text-sm text-nowrap flex mt-6 xl:mt-3.5">Diameter of Wire Rope (mm):
                      <TooltipIcon tooltipText="Diameter of Wire Rope (mm)"/>
                    </div>
