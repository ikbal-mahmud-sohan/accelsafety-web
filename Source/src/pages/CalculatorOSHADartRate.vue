...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">OSHA DART Rate Calculator</h2>
  </div>
  <div class="grid grid-cols-11 pb-20 mt-5 gap-x-6">
    ...
    >
      <div class="flex items-center">
        ...
        <span>
          Note: This calculator is for educational purposes only. Always follow manufacturer guidelines for accurate OSHA DART Rate calculation.
          <a
    ...
    <div class="col-span-11 intro-y 2xl:col-span-9">
      ...
      <div class="p-5 mt-5 intro-y box">
        ...
        >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> OSHA DART Rate Calculator
          </div>
          <div class="mt-5">
            <FormInline class="flex flex-col flex-wrap mt-2 xl:flex-row first:mt-0 first:pt-0">
              <FormLabel class="xl:w-64 xl:!mr-10">
                <div class="text-left">
                  <div class="flex items-center pr-4">
                    <div class="font-medium text-sm flex mt-6 xl:mt-3.5">Total Number of DART Incidents:
                      <TooltipIcon tooltipText="Total Number of DART Incidents:"/>
                    </div>
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <FormInput class="w-full" type="number" name="" placeholder="The sum of workplace incidents resulting in days away from work, required restricted work or transfer"/>
                  <div class="flex justify-between">
            ...
            <FormInline class="flex flex-col flex-wrap mt-2 xl:flex-row first:mt-0 first:pt-0">
              <FormLabel class="xl:w-64 xl:!mr-10">
                <div class="text-left">
                  <div class="flex items-center pr-4">
                    <div class="font-medium text-sm text-nowrap flex mt-6 xl:mt-3.5">Total Hours Worked:
                      <TooltipIcon tooltipText="Total Hours Worked"/>
                    </div>
                    <!-- <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md mt-6 xl:mt-3.5">
                      Required
                    </div> -->
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <FormInput class="w-full" type="number" name="" placeholder="The total no. of hours your employees + contractors have worked (without leaves or holidays)"/>
                  <div class="flex justify-between">
                    <p class="text-right mt-2 w-full"> Required</p>
                </div>
              </div>
      ...
      <div class="relative p-5 mt-10 border rounded-md bg-success/20 dark:bg-darkmode-600 border-success dark:border-0">
          ...
          <div class="mt-2 text-xs leading-relaxed text-slate-600 dark:text-slate-500">
            <div class="mt-1 text-sm"><strong> OSHA DART Rate: 7000.00</strong></div>
          </div>
      </div>
      <!-- results:end -->
    </div>
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <a href="">OSHA DART Rate Calculator</a>
          </li>
          <li
