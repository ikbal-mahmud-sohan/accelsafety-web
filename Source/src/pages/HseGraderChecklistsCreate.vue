...
const submitForm = async () => {
   formData.grader_des_1 = 'Machine should be physically good & should have valid TPI certificate';
   formData.grader_des_2 = 'No damage in tire (Bolts, crack, cuts & air pressure, etc.)';
   formData.grader_des_3 = 'Head & tail light and indicators are in working condition';
   formData.grader_des_4 = 'Side mirror should be in good condition';
   formData.grader_des_5 = 'Wind shield/glass should be in proper condition';
   formData.grader_des_6 = 'Wiper should be in running condition';
   formData.grader_des_7 = 'Canopy above driver seat should be made by good & sound quality of material';
   formData.grader_des_8 = 'Hydraulic cylinders should be in good condition and free from leakage';
   formData.grader_des_9 = 'Red triangle/reflective tape should be fixed in front of vehicle';
   formData.grader_des_10 = 'Front & revers horn.';
   formData.grader_des_11 = 'Fire extinguisher in operator cabin.';
   formData.grader_des_12 = 'Operator have suitable license.';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_grader_1 = ishvcomplied1.value;
  formData.is_grader_2 = ishvcomplied2.value;
  formData.is_grader_3 = ishvcomplied3.value;
  formData.is_grader_4 = ishvcomplied4.value;
  formData.is_grader_5 = ishvcomplied5.value;
  formData.is_grader_6 = ishvcomplied6.value;
  formData.is_grader_7 = ishvcomplied7.value;
  formData.is_grader_8 = ishvcomplied8.value;
  formData.is_grader_9 = ishvcomplied9.value;
  formData.is_grader_10 = ishvcomplied10.value;
  formData.is_grader_11 = ishvcomplied11.value;
  formData.is_grader_12 = ishvcomplied12.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/grader-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'grader-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">35 Grader</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> 35 Grader
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_1" class="w-full" type="text" name="grader_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_2" class="w-full" type="text" name="grader_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_3" class="w-full" type="text" name="grader_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_4" class="w-full" type="text" name="grader_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_5" class="w-full" type="text" name="grader_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_6" class="w-full" type="text" name="grader_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Canopy above driver seat should be made by good & sound quality of material</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_7" class="w-full" type="text" name="grader_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_8" class="w-full" type="text" name="grader_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_9" class="w-full" type="text" name="grader_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Front & revers horn.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_10" class="w-full" type="text" name="grader_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_11" class="w-full" type="text" name="grader_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.grader_remarks_12" class="w-full" type="text" name="grader_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/35Grader.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the 35 Grader report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">35 Grader success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Grader failed!</div>
