...
const submitForm = async () => {
   formData.boom_placer_des_1 = 'Boom placer should be physically good.';
   formData.boom_placer_des_2 = 'No damage in tire (Bolts, crack, cuts & air pressure, etc.)';
   formData.boom_placer_des_3 = 'Head & tail light and indicators are in working condition';
   formData.boom_placer_des_4 = 'Outrigger should be free from damages';
   formData.boom_placer_des_5 = 'Wind shield/glass should be in proper condition';
   formData.boom_placer_des_6 = 'Wiper should be in running condition';
   formData.boom_placer_des_7 = 'Side mirror should be in good condition';
   formData.boom_placer_des_8 = 'Boom should be free from defects';
   formData.boom_placer_des_9 = 'Hydraulic cylinder and hoses should be in good condition and free from leakage';
   formData.boom_placer_des_10 = 'Pipe should be free from defects e.g. bend, crack, etc';
   formData.boom_placer_des_11 = 'Red triangle/reflective tape should be fixed in front of vehicle';
   formData.boom_placer_des_12 = 'Rotatory part of secondary engine should be covered with fix guard';
   formData.boom_placer_des_13 = 'Front & reverse horn';
   formData.boom_placer_des_14 = 'Fire extinguisher in operator cabin';
   formData.boom_placer_des_15 = 'Operator have suitable license/experience certificate';
   formData.boom_placer_des_16 = 'First aid kit should be available.';
   formData.boom_placer_des_17 = 'Normal break & emergency (hand) break should be in functional & operational condition.';
   formData.boom_placer_des_18 = 'Concrete hopper should be covered with mesh.';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_boom_placer_1 = ishvcomplied1.value;
  formData.is_boom_placer_2 = ishvcomplied2.value;
  formData.is_boom_placer_3 = ishvcomplied3.value;
  formData.is_boom_placer_4 = ishvcomplied4.value;
  formData.is_boom_placer_5 = ishvcomplied5.value;
  formData.is_boom_placer_6 = ishvcomplied6.value;
  formData.is_boom_placer_7 = ishvcomplied7.value;
  formData.is_boom_placer_8 = ishvcomplied8.value;
  formData.is_boom_placer_9 = ishvcomplied9.value;
  formData.is_boom_placer_10 = ishvcomplied10.value;
  formData.is_boom_placer_11 = ishvcomplied11.value;
  formData.is_boom_placer_12 = ishvcomplied12.value;
  formData.is_boom_placer_13 = ishvcomplied13.value;
  formData.is_boom_placer_14 = ishvcomplied14.value;
  formData.is_boom_placer_15 = ishvcomplied14.value;
  formData.is_boom_placer_16 = ishvcomplied14.value;
  formData.is_boom_placer_17 = ishvcomplied14.value;
  formData.is_boom_placer_18 = ishvcomplied14.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/boom-placer-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-boom-placer-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Boom Placer</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Boom Placer
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Boom placer should be physically good.
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_1" class="w-full" type="text" name="boom_placer_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_2" class="w-full" type="text" name="boom_placer_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_3" class="w-full" type="text" name="boom_placer_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Outrigger should be free from damages</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_4" class="w-full" type="text" name="boom_placer_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_5" class="w-full" type="text" name="boom_placer_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_6" class="w-full" type="text" name="boom_placer_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_7" class="w-full" type="text" name="boom_placer_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Boom should be free from defects</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_8" class="w-full" type="text" name="boom_placer_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Hydraulic cylinder and hoses should be in good condition and
                        free from leakage</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_9" class="w-full" type="text" name="boom_placer_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Pipe should be free from defects e.g. bend, crack, etc</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_10" class="w-full" type="text" name="boom_placer_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Red triangle/reflective tape should be fixed in front of vehicle</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_11" class="w-full" type="text" name="boom_placer_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Rotatory part of secondary engine should be covered with fix guard</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_12" class="w-full" type="text" name="boom_placer_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_13" class="w-full" type="text" name="boom_placer_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_14" class="w-full" type="text" name="boom_placer_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_15" class="w-full" type="text" name="boom_placer_remarks_15" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_16" class="w-full" type="text" name="boom_placer_remarks_16" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Normal break & emergency (hand) break should be in functional
                        & operational condition.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_17" class="w-full" type="text" name="boom_placer_remarks_17" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Concrete hopper should be covered with mesh.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.boom_placer_remarks_18" class="w-full" type="text" name="boom_placer_remarks_18" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/BoomPlacer.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Boom Placer report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Boom Placer success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Boom Placer failed!</div>
