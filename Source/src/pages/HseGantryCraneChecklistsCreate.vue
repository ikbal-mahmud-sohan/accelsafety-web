...
const submitForm = async () => {
   formData.gantry_crane_des_1 = 'Machine should be physically good & Should have valid TPI certificate';
   formData.gantry_crane_des_2 = 'SWL should be visible on either side';
   formData.gantry_crane_des_3 = 'Walkaway should be in good condition and free from obstruction';
   formData.gantry_crane_des_4 = 'Access ladder should be provided with cage';
   formData.gantry_crane_des_5 = 'Proximity sensor should be in working condition';
   formData.gantry_crane_des_6 = 'Operator cabin should be in good condition and clean';
   formData.gantry_crane_des_7 = 'Wire sling should be free from damage';
   formData.gantry_crane_des_8 = 'Hook latch must be installed in hook';
   formData.gantry_crane_des_9 = 'Guardrail system should be provided';
   formData.gantry_crane_des_10 = 'Rotating part of motor should be covered';
   formData.gantry_crane_des_11 = 'Wire sling drum should be under canopy';
   formData.gantry_crane_des_12 = 'Audible horn should be in working condition';
   formData.gantry_crane_des_13 = 'Fire extinguisher in operator cabin';
   formData.gantry_crane_des_14 = 'Operator have suitable license';
   formData.gantry_crane_des_15 = 'Deflection test should be carried out';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_gantry_crane_1 = ishvcomplied1.value;
  formData.is_gantry_crane_2 = ishvcomplied2.value;
  formData.is_gantry_crane_3 = ishvcomplied3.value;
  formData.is_gantry_crane_4 = ishvcomplied4.value;
  formData.is_gantry_crane_5 = ishvcomplied5.value;
  formData.is_gantry_crane_6 = ishvcomplied6.value;
  formData.is_gantry_crane_7 = ishvcomplied7.value;
  formData.is_gantry_crane_8 = ishvcomplied8.value;
  formData.is_gantry_crane_9 = ishvcomplied9.value;
  formData.is_gantry_crane_10 = ishvcomplied10.value;
  formData.is_gantry_crane_11 = ishvcomplied11.value;
  formData.is_gantry_crane_12 = ishvcomplied12.value;
  formData.is_gantry_crane_13 = ishvcomplied13.value;
  formData.is_gantry_crane_14 = ishvcomplied14.value;
  formData.is_gantry_crane_15 = ishvcomplied15.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/gantry-crane-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'gantry-crane-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Gantry Crane</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Gantry Crane
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Machine should be physically good & Should have valid TPI certificate
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_1" class="w-full" type="text" name="gantry_crane_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">SWL should be visible on either side</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_2" class="w-full" type="text" name="gantry_crane_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Walkaway should be in good condition and free from obstruction</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_3" class="w-full" type="text" name="gantry_crane_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Access ladder should be provided with cage</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_4" class="w-full" type="text" name="gantry_crane_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Proximity sensor should be in working condition</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_5" class="w-full" type="text" name="gantry_crane_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operator cabin should be in good condition and clean</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_6" class="w-full" type="text" name="gantry_crane_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Wire sling should be free from damage</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_7" class="w-full" type="text" name="gantry_crane_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Hook latch must be installed in hook</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_8" class="w-full" type="text" name="gantry_crane_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Guardrail system should be provided</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_9" class="w-full" type="text" name="gantry_crane_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Rotating part of motor should be covered</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_10" class="w-full" type="text" name="gantry_crane_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Wire sling drum should be under canopy</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_11" class="w-full" type="text" name="gantry_crane_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Audible horn should be in working condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_12" class="w-full" type="text" name="gantry_crane_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_13" class="w-full" type="text" name="gantry_crane_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operator have suitable license</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_14" class="w-full" type="text" name="gantry_crane_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Deflection test should be carried out</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gantry_crane_remarks_15" class="w-full" type="text" name="gantry_crane_remarks_15" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/36GantryCrane.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Gantry Crane report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Gantry Crane success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Gantry Crane failed!</div>
