...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Visitor Log</h2>
  </div>
  <div class="grid grid-cols-11 pb-20 mt-5 gap-x-6">
    ...
    >
      <div class="flex items-center">
        ...
        <span>
          Ensure accurate online Visitor Log with correct date formats and file uploads in the specified format and size.
          <a
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Visitor Log report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
