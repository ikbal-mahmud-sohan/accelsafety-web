      ...
      <Table class="border-spacing-y-[10px] border-separate -mt-2">
        <Table.Thead>
          <Table.Tr>
            ...
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">Dying Re Use Water</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">Rain_Water</Table.Th>
          </Table.Tr>
        </Table.Thead>
