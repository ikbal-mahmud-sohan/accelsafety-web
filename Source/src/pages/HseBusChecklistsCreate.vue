...
const submitForm = async () => {
   formData.buse_des_1 = 'Physical condition of vehicle is good';
   formData.buse_des_2 = 'No damage in tire (Bolts, crack, cuts & air pressure, etc.';
   formData.buse_des_3 = 'Side mirror should be in good condition';
   formData.buse_des_4 = 'Head & tail light and indicators are in working condition.';
   formData.buse_des_5 = 'Wiper should be in running condition';
   formData.buse_des_6 = 'Wind shield/glass should be in proper condition';
   formData.buse_des_7 = 'Seatbelt should be available';
   formData.buse_des_8 = 'Reflective tape should be fixed in front of vehicle';
   formData.buse_des_9 = 'Registration number should be written';
   formData.buse_des_10 = 'Door lock are good condition';
   formData.buse_des_11 = 'Front & reverse horn';
   formData.buse_des_12 = 'Fire extinguisher in operator cabin';
   formData.buse_des_13 = 'Operator have valid and suitable license';
   formData.buse_des_14 = 'First aid kit should be available';
   formData.buse_des_15 = 'Normal break & emergency (hand) break should be in functional & operational condition';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_buse_1 = ishvcomplied1.value;
  formData.is_buse_2 = ishvcomplied2.value;
  formData.is_buse_3 = ishvcomplied3.value;
  formData.is_buse_4 = ishvcomplied4.value;
  formData.is_buse_5 = ishvcomplied5.value;
  formData.is_buse_6 = ishvcomplied6.value;
  formData.is_buse_7 = ishvcomplied7.value;
  formData.is_buse_8 = ishvcomplied8.value;
  formData.is_buse_9 = ishvcomplied9.value;
  formData.is_buse_10 = ishvcomplied10.value;
  formData.is_buse_11 = ishvcomplied11.value;
  formData.is_buse_12 = ishvcomplied12.value;
  formData.is_buse_13 = ishvcomplied13.value;
  formData.is_buse_14 = ishvcomplied14.value;
  formData.is_buse_15 = ishvcomplied15.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/bus-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'bus-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Bus</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Bus
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_1" class="w-full" type="text" name="buse_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_2" class="w-full" type="text" name="buse_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_3" class="w-full" type="text" name="buse_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_4" class="w-full" type="text" name="buse_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_5" class="w-full" type="text" name="buse_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_6" class="w-full" type="text" name="buse_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_7" class="w-full" type="text" name="buse_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_8" class="w-full" type="text" name="buse_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_9" class="w-full" type="text" name="buse_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_10" class="w-full" type="text" name="buse_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_11" class="w-full" type="text" name="buse_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_12" class="w-full" type="text" name="buse_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_13" class="w-full" type="text" name="buse_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_14" class="w-full" type="text" name="buse_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.buse_remarks_15" class="w-full" type="text" name="buse_remarks_15" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/41Bus.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Bus report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Bus success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Bus failed!</div>
