...
const submitForm = async () => {
   formData.fire_extinguisher_des_1 = 'Fire extinguisher always keep on trolley, it will be easy for movement';
   formData.fire_extinguisher_des_2 = 'Keep Sand bucket';
   formData.fire_extinguisher_des_3 = 'Sand bucket should be covered to avoid mixing of foreign material';
   formData.fire_extinguisher_des_4 = 'Fire extinguisher should be kept at waist level height for quick access';
   formData.fire_extinguisher_des_5 = 'Fire extinguisher should be free from defects and regularly tested';
   formData.fire_extinguisher_des_6 = 'Inspection date and due date should be clearly marked';
   formData.fire_extinguisher_des_7 = 'Hose and hose connection are in good condition';
   formData.fire_extinguisher_des_8 = 'Check pressure gauge at regular interval for any pressure drop';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_fire_extinguisher_1 = ishvcomplied1.value;
  formData.is_fire_extinguisher_2 = ishvcomplied2.value;
  formData.is_fire_extinguisher_3 = ishvcomplied3.value;
  formData.is_fire_extinguisher_4 = ishvcomplied4.value;
  formData.is_fire_extinguisher_5 = ishvcomplied5.value;
  formData.is_fire_extinguisher_6 = ishvcomplied6.value;
  formData.is_fire_extinguisher_7 = ishvcomplied7.value;
  formData.is_fire_extinguisher_8 = ishvcomplied8.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/fire-extinguisher-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'fire-extinguisher-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Fire Extinguisher</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Fire Extinguisher
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Fire extinguisher always keep on trolley, it will be easy for movement
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.fire_extinguisher_remarks_1" class="w-full" type="text" name="fire_extinguisher_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Keep Sand bucket</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.fire_extinguisher_remarks_2" class="w-full" type="text" name="fire_extinguisher_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Sand bucket should be covered to avoid mixing of foreign material</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.fire_extinguisher_remarks_3" class="w-full" type="text" name="fire_extinguisher_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Fire extinguisher should be kept at waist level height for quick access</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.fire_extinguisher_remarks_4" class="w-full" type="text" name="fire_extinguisher_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Fire extinguisher should be free from defects and regularly tested</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.fire_extinguisher_remarks_5" class="w-full" type="text" name="fire_extinguisher_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.fire_extinguisher_remarks_6" class="w-full" type="text" name="fire_extinguisher_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Hose and hose connection are in good condition</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.fire_extinguisher_remarks_7" class="w-full" type="text" name="fire_extinguisher_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Check pressure gauge at regular interval for any pressure drop</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.fire_extinguisher_remarks_8" class="w-full" type="text" name="fire_extinguisher_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div>
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/FireExtinguisher.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Fire Extinguisher report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Fire Extinguisher success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Fire Extinguisher failed!</div>
