...
<template>
  ...
  <div class="pb-8">
    <h2 class="text-2xl font-medium intro-y text-center uppercase">Personal Protective Equipment</h2>
  </div>
    ...
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        <div class="border py-2">
          ...
          <router-link :to="{ name: 'hse-personal-protective-equipment-doc' }">
        ...
        <div class="py-1">
          <p class="text-center">Personal Protective Equipment documentation</p>
        </div>
        </div>
      </div>
    </div>
