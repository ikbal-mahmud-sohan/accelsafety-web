...
const fetchData = async () => {
  try {
   let  url = config.baseURL+'/api/v1/isgec-backhoe-loaders';
...
const deleteData = async (sID:string) => {
  try {
    let url = config.baseURL+"/api/v1/isgec-backhoe-loaders/"+sID;
...
<template>
  <h2 class="mt-10 text-lg font-medium intro-y">Backhoe Loader List</h2>
      ...
      <Table class="border-spacing-y-[10px] border-separate -mt-2">
        <Table.Thead>
          <Table.Tr>
            ...
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">project name</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">project code</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">checklist no</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">date</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">make</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">model</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">inspected by</Table.Th>
        ...
        <Table.Tbody>
          <Table.Tr v-for="(report, index) in state.viewData" :key="index" class="intro-x">
            ...
            >
              <div class="flex items-center justify-center">
                <router-link :to="{name:'designation-update-form', params:{id:report.id} }" class="flex items-center mr-3">
