...
<template>
  <h2 class="mt-10 text-lg font-medium intro-y">Department List</h2>
          ...
          <Table.Tr v-for="(report, index) in state.viewData" :key="index" class="intro-x">
            ...
            >
              <div class="flex items-center justify-center">
                <router-link :to="{name:'department-update-form', params:{id:report.id} }" class="flex items-center mr-3">
