...
const submitForm = async () => {
   formData.hydra_des_1 = 'Hydra should be physically good & certified by TPI';
   formData.hydra_des_2 = 'No damage in tire (Bolts, crack, cuts & air pressure, etc.)';
   formData.hydra_des_3 = 'Registration number should be written';
   formData.hydra_des_4 = 'Head & tail light and indicators are in working condition';
   formData.hydra_des_5 = 'No oil leakage in hydraulic part';
   formData.hydra_des_6 = 'Safe work load (SWL) marked.';
   formData.hydra_des_7 = 'Sling drum should be in good condition';
   formData.hydra_des_8 = 'Boom condition while full extension (free from damage, crack & jamming, etc.)';
   formData.hydra_des_9 = 'Wire rope free from damage';
   formData.hydra_des_10 = 'Hoist limit switch';
   formData.hydra_des_11 = 'Safety latch in hook';
   formData.hydra_des_12 = 'Safe load indicator should be in working condition';
   formData.hydra_des_13 = 'Front & reverse horn';
   formData.hydra_des_14 = 'Fire extinguisher in operator cabin';
   formData.hydra_des_15 = 'Operator should have valid license (heavy duty)';
   formData.hydra_des_16 = 'Load chart available in operator cabin';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_hydra_1 = ishvcomplied1.value;
  formData.is_hydra_2 = ishvcomplied2.value;
  formData.is_hydra_3 = ishvcomplied3.value;
  formData.is_hydra_4 = ishvcomplied4.value;
  formData.is_hydra_5 = ishvcomplied5.value;
  formData.is_hydra_6 = ishvcomplied6.value;
  formData.is_hydra_7 = ishvcomplied7.value;
  formData.is_hydra_8 = ishvcomplied8.value;
  formData.is_hydra_9 = ishvcomplied9.value;
  formData.is_hydra_10 = ishvcomplied10.value;
  formData.is_hydra_11 = ishvcomplied11.value;
  formData.is_hydra_12 = ishvcomplied12.value;
  formData.is_hydra_13 = ishvcomplied13.value;
  formData.is_hydra_14 = ishvcomplied14.value;
  formData.is_hydra_15 = ishvcomplied14.value;
  formData.is_hydra_16 = ishvcomplied14.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/hydra-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-hydra-checklists' });
                }
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Hydra should be physically good & certified by TPI
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_1" class="w-full" type="text" name="hydra_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_2" class="w-full" type="text" name="hydra_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_3" class="w-full" type="text" name="hydra_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_4" class="w-full" type="text" name="hydra_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_5" class="w-full" type="text" name="hydra_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_6" class="w-full" type="text" name="hydra_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Sling drum should be in good condition</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_7" class="w-full" type="text" name="hydra_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_8" class="w-full" type="text" name="hydra_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_9" class="w-full" type="text" name="hydra_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_10" class="w-full" type="text" name="hydra_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_11" class="w-full" type="text" name="hydra_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_12" class="w-full" type="text" name="hydra_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_13" class="w-full" type="text" name="hydra_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_14" class="w-full" type="text" name="hydra_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operator should have valid license (heavy duty)</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_15" class="w-full" type="text" name="hydra_remarks_15" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Load chart available in operator cabin</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.hydra_remarks_16" class="w-full" type="text" name="hydra_remarks_16" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/Hydra.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
