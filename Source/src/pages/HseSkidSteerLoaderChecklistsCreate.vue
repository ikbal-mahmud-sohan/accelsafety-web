...
const submitForm = async () => {
   formData.skid_steer_des_1 = 'Machine should be physically good & should have valid TPI certificate.';
   formData.skid_steer_des_2 = 'No damage in tire (Bolts, crack, cuts & air pressure, etc.)';
   formData.skid_steer_des_3 = 'Head & tail light and indicators are in working condition';
   formData.skid_steer_des_4 = 'Side mirror should be in good condition';
   formData.skid_steer_des_5 = 'Wind shield/glass should be in proper condition';
   formData.skid_steer_des_6 = 'Wiper should be in running condition';
   formData.skid_steer_des_7 = 'Operator cabin should be made by good & sound quality of material';
   formData.skid_steer_des_8 = 'Hydraulic cylinders should be in good condition and free from leakage';
   formData.skid_steer_des_9 = 'Foot Step should be free from slip or tip hazard';
   formData.skid_steer_des_10 = 'Red triangle/reflective tape should be fixed in front of vehicle';
   formData.skid_steer_des_11 = 'Front & reverse horn';
   formData.skid_steer_des_12 = 'Fire extinguisher in operator cabin';
   formData.skid_steer_des_13 = 'Operator have suitable license';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_skid_steer_1 = ishvcomplied1.value;
  formData.is_skid_steer_2 = ishvcomplied2.value;
  formData.is_skid_steer_3 = ishvcomplied3.value;
  formData.is_skid_steer_4 = ishvcomplied4.value;
  formData.is_skid_steer_5 = ishvcomplied5.value;
  formData.is_skid_steer_6 = ishvcomplied6.value;
  formData.is_skid_steer_7 = ishvcomplied7.value;
  formData.is_skid_steer_8 = ishvcomplied8.value;
  formData.is_skid_steer_9 = ishvcomplied9.value;
  formData.is_skid_steer_10 = ishvcomplied10.value;
  formData.is_skid_steer_11 = ishvcomplied11.value;
  formData.is_skid_steer_12 = ishvcomplied12.value;
  formData.is_skid_steer_13 = ishvcomplied13.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/skidSteer-loader-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'skidSteer-loader-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">34 Skid Steer Loader</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> 34 Skid Steer Loader
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_1" class="w-full" type="text" name="skid_steer_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_2" class="w-full" type="text" name="skid_steer_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_3" class="w-full" type="text" name="skid_steer_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_4" class="w-full" type="text" name="skid_steer_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_5" class="w-full" type="text" name="skid_steer_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_6" class="w-full" type="text" name="skid_steer_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operator cabin should be made by good & sound quality of material</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_7" class="w-full" type="text" name="skid_steer_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Hydraulic cylinders should be in good condition and free from leakage</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_8" class="w-full" type="text" name="skid_steer_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Foot Step should be free from slip or tip hazard</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_9" class="w-full" type="text" name="skid_steer_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_10" class="w-full" type="text" name="skid_steer_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_11" class="w-full" type="text" name="skid_steer_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_12" class="w-full" type="text" name="skid_steer_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.skid_steer_remarks_13" class="w-full" type="text" name="skid_steer_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/34SkidSteerLoader.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Skid Steer Loader report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Skid Steer Loader success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">skid_steer failed!</div>
