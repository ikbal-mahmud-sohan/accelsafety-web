  ...
  cvformData.created_by = state.uID;
    ...
    if (validate.value.$invalid) {
            ...
            try {
                ...
                let  url = config.baseURL+'/api/v1/hse-emergency-response-sop-doc';
  ...
  cvUpdateformData.updated_by = state.uID;
    ...
    if (validate2.value.$invalid) {
            ...
            try {
                ...
                let  url = config.baseURL+'/api/v1/hse-emergency-response-sop-doc/update/'+cvformData.id;
  ...
  //  let  url = config.baseURL+'/api/v1/hse-safety-power-tools';
   let  url = config.baseURL+'/api/v1/hse-emergency-response-sop-doc';
    ...
    if (state.viewData.length === 0) {
      state.AddControlVisitorsHSE01 = true; // Show "Insert Emergency Response" section
      state.UpdateControlVisitorsHSE01 = false;
    } else {
      state.AddControlVisitorsHSE01 = false;
      state.UpdateControlVisitorsHSE01 = true; // Show "Update Emergency Response" section
    }
...
const fetchcvUpdateData = async () => {
  try {
  //  let  url = config.baseURL+'/api/v1/hse-safety-power-tools/'+cvformData.id;
   let  url = config.baseURL+'/api/v1/hse-emergency-response-sop-doc/show/'+cvformData.id;
    const response = await axios.get(url,{
                headers: {
                    'Authorization': state.token,
                },
  ...
  <div class="w-full">
    ...
    <div class="bg-white z-50 shadow-md rounded-md p-4 w-full">
      ...
      <div class="p-4" v-if="state.AddControlVisitorsHSE01">
        ...
        <div class="py-4"><h2 class="mr-auto text-xl text-center font-medium uppercase">Insert Emergency Response</h2></div>
          <Alert variant="primary" dismissible class="col-span-11 mb-6 intro-y box dark:border-darkmode-600" v-slot="{ dismiss }">
              <div class="flex items-center">
                ...
                <span>
                  Ensure accurate online Emergency Response with correct date formats and file uploads in the specified format and size.
                </span>
      ...
      <div class="p-4" v-if="state.UpdateControlVisitorsHSE01">
        <div class="p-5 mt-5 intro-y box">
        <div class="py-4"><h2 class="mr-auto text-xl text-center font-medium uppercase">Update Emergency Response</h2></div>
          <Alert variant="primary" dismissible class="col-span-11 mb-6 intro-y box dark:border-darkmode-600" v-slot="{ dismiss }">
              <div class="flex items-center">
                <span>
                  <Lucide icon="Info" class="w-4 h-4 mr-2" />
