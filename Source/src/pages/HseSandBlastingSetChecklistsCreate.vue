...
const submitForm = async () => {
   formData.sand_blasting_des_1 = 'Hopper is made by sound quality of material.';
   formData.sand_blasting_des_2 = 'Pressure gauge in working condition.';
   formData.sand_blasting_des_3 = 'All joints should be properly tighten and free from corrosion.';
   formData.sand_blasting_des_4 = 'Inlet and outlet valve should be functional';
   formData.sand_blasting_des_5 = 'Blasting hose should have adequate strength and free from cuts or damages';
   formData.sand_blasting_des_6 = 'Nozzle should be in good condition with dead man switch';
   formData.sand_blasting_des_7 = 'Blasting hood must be provided for blaster with physical particle filtration';
   formData.sand_blasting_des_8 = 'Whip arrestor is in good condition';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_sand_blasting_1 = ishvcomplied1.value;
  formData.is_sand_blasting_2 = ishvcomplied2.value;
  formData.is_sand_blasting_3 = ishvcomplied3.value;
  formData.is_sand_blasting_4 = ishvcomplied4.value;
  formData.is_sand_blasting_5 = ishvcomplied5.value;
  formData.is_sand_blasting_6 = ishvcomplied6.value;
  formData.is_sand_blasting_7 = ishvcomplied7.value;
  formData.is_sand_blasting_8 = ishvcomplied8.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/sand-blasting-set-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'sand-blasting-set-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Grit / Sand Blasting Set</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Grit / Sand Blasting Set
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Hopper is made by sound quality of material.
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.sand_blasting_remarks_1" class="w-full" type="text" name="sand_blasting_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Pressure gauge in working condition.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.sand_blasting_remarks_2" class="w-full" type="text" name="sand_blasting_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">All joints should be properly tighten and free from corrosion.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.sand_blasting_remarks_3" class="w-full" type="text" name="sand_blasting_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Inlet and outlet valve should be functional</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.sand_blasting_remarks_4" class="w-full" type="text" name="sand_blasting_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Blasting hose should have adequate strength and free from cuts or damages</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.sand_blasting_remarks_5" class="w-full" type="text" name="sand_blasting_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Nozzle should be in good condition with dead man switch</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.sand_blasting_remarks_6" class="w-full" type="text" name="sand_blasting_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Blasting hood must be provided for blaster with physical particle filtration</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.sand_blasting_remarks_7" class="w-full" type="text" name="sand_blasting_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.sand_blasting_remarks_8" class="w-full" type="text" name="sand_blasting_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/SandBlastingSet.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <a href="">Grit / Sand Blasting Set</a>
          </li>
          <li
        ...
        >
          ...
          >
            <div>
              When filling out the Grit / Sand Blasting Set report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Grit / Sand Blasting Set success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Grit / Sand Blasting Set failed!</div>
