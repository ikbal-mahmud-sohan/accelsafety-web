    ...
    if (validate.value.$invalid) {
      FailedPopUp();
            ...
            try {
                ...
                ? `${config.baseURL}/api/v1/fire-extinguisher-ton/update/${state.entryId}`
                : `${config.baseURL}/api/v1/fire-extinguisher-ton`;
              ...
              router.push({ name: 'hse-fire-extinguisher-ton-list' });
...
const fetchEntryData = async (id: string) => {
  try {
    const response = await axios.get(`${config.baseURL}/api/v1/fire-extinguisher-ton/edit/${id}`, {
      headers: {
        'Authorization': state.token,
      },
    });
    ...
    console.log('Fetched fireExtTON Data:', data);
...
<template>
  <div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="col-span-12   overflow-y-auto ">
        <div class="risk-form-head">
            <div class="py-4 bg-theme-1">
                <p class=" text-base font-semibold uppercase text-center text-white">{{ state.isEditMode ? 'Fire Extinguisher TON FORM Edit' : 'Fire Extinguisher TON FORM' }}</p>
            </div>
   ...
   <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium text-nowrap">Fire Extinguisher TON {{ state.isEditMode ? 'Editing' : 'Create' }} success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium text-nowrap">Fire Extinguisher TON {{ state.isEditMode ? 'Edit' : 'Create' }} failed!</div>
