...
const submitForm = async () => {
  ...
  if (validate.value.$invalid) {
    ...
    try {
      let url = config.baseURL + '/api/v1/hse-drill-report-doc';
...
const fetchcvUpdateData = async () => {
  try {
    ...
    let url = config.baseURL + '/api/v1/hse-drill-report-doc/show/' + cvformData.id;
    const response = await axios.get(url, {
      headers: {
        'Authorization': state.token,
      },
  ...
  <div class="w-full">
    ...
    <div class=" bg-white z-50 shadow-md rounded-md p-4 w-full">
      <div class="pt-4 px-4 flex justify-end items-center">
        <router-link :to="{ name: 'hse-emergency-drill' }">
      ...
      <div class="p-4" v-if="state.AddControlVisitorsHSE01">
        <div class="p-5 mt-5 intro-y box">
          <div class="py-4">
            <h2 class="mr-auto text-xl text-center font-medium uppercase">Insert Emergency Drill Report Doc</h2>
          </div>
          <Alert variant="primary" dismissible class="col-span-11 mb-6 intro-y box dark:border-darkmode-600"
            ...
            <div class="flex items-center">
              ...
              <span>
                Ensure accurate online Emergency Drill Report with correct date formats and file uploads in the specified
                format and size.
              </span>
      ...
      <div class="p-4" v-if="state.UpdateControlVisitorsHSE01">
        <div class="p-5 mt-5 intro-y box">
          <div class="py-4">
            <h2 class="mr-auto text-xl text-center font-medium uppercase">Update Emergency Drill Report doc</h2>
          </div>
          <Alert variant="primary" dismissible class="col-span-11 mb-6 intro-y box dark:border-darkmode-600"
            v-slot="{ dismiss }">
            <div class="flex items-center">
