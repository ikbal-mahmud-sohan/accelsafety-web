...
const deleteData = async (sID:string) => {
  try {
    let url = config.baseURL+"/api/v1/sand-blasting-set-checklists/"+sID;
...
<template>
  <h2 class="mt-10 text-lg font-medium intro-y">List Grit / Sand Blasting Set</h2>
  <div class="grid grid-cols-12 gap-6 mt-5">
    <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">
      <router-link :to="{ name: 'sand-blasting-set-checklists-create' }">
        <Button variant="primary" class="mr-2 shadow-md">
          Add Grit / Sand Blasting Set
        </Button>
      </router-link>
      <Menu>
