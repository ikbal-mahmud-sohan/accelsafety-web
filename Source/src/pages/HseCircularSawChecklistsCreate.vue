...
const submitForm = async () => {
   formData.circular_saw_des_1 = 'Physical condition of compressor tank should be good and certified by TPI.';
   formData.circular_saw_des_2 = 'Piston should be in good condition';
   formData.circular_saw_des_3 = 'Motor should be in good and working condition';
   formData.circular_saw_des_4 = 'Inspection date and due date should be clearly marked';
   formData.circular_saw_des_5 = 'Pressure gauge should be in working state and free from defects';
   formData.circular_saw_des_6 = 'Safety valve should be calibrated at regular interval';
   formData.circular_saw_des_7 = 'Any other valve should be free from defects and in working condition';
   formData.circular_saw_des_8 = 'Rotating part should be covered with fixed guard';
   formData.circular_saw_des_9 = 'All joints should be properly tighten';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_circular_saw_1 = ishvcomplied1.value;
  formData.is_circular_saw_2 = ishvcomplied2.value;
  formData.is_circular_saw_3 = ishvcomplied3.value;
  formData.is_circular_saw_4 = ishvcomplied4.value;
  formData.is_circular_saw_5 = ishvcomplied5.value;
  formData.is_circular_saw_6 = ishvcomplied6.value;
  formData.is_circular_saw_7 = ishvcomplied7.value;
  formData.is_circular_saw_8 = ishvcomplied8.value;
  formData.is_circular_saw_9 = ishvcomplied9.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/circular-saw-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'circular-saw-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Circular Saw</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Circular Saw
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_1" class="w-full" type="text" name="circular_saw_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_2" class="w-full" type="text" name="circular_saw_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_3" class="w-full" type="text" name="circular_saw_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_4" class="w-full" type="text" name="circular_saw_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_5" class="w-full" type="text" name="circular_saw_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_6" class="w-full" type="text" name="circular_saw_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_7" class="w-full" type="text" name="circular_saw_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_8" class="w-full" type="text" name="circular_saw_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.circular_saw_remarks_9" class="w-full" type="text" name="circular_saw_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/CircularSaw.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Circular Saw report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Circular Saw success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Circular Saw failed!</div>
