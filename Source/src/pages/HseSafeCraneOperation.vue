...
<template>
  ...
  <div class="pb-8">
    <h2 class="text-2xl font-medium intro-y text-center uppercase">Safe Crane Operation</h2>
  </div>
  <div class="flex flex-wrap bg-theme-1 bg-opacity-20 px-4 py-4 rounded-md shadow-md">
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        <div class="border py-2">
          ...
          <router-link :to="{ name: 'hse-safe-crane-operation-doc' }">
        ...
        <div class="py-1">
          <p class="text-center">Safe Crane Operation documentation</p>
        </div>
        </div>
      </div>
    </div>
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        ...
        <div class="py-1">
          <p class="text-center">Master Lifting Equipments Create</p>
        </div>
        </div>
      </div>
    </div>
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        <div class="border py-2">
          <div class="flex justify-center items-center p-4">
          <router-link :to="{ name: 'hse-master-listLifting-equipments' }">
            <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/crane.png" alt="">
            </div>
          </router-link>
        ...
        <div class="py-1">
          <p class="text-center">Master List of Lifting Equipments</p>
        </div>
        </div>
      </div>
    </div>
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        ...
        <div class="py-1">
          <p class="text-center">Lifting Loose Gears Create</p>
        </div>
        </div>
      </div>
    </div>
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        <div class="border py-2">
          <div class="flex justify-center items-center p-4">
          <router-link :to="{ name: 'hse-lifting-loose-gears' }">
            <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/crane.png" alt="">
            </div>
          </router-link>
        ...
        <div class="py-1">
          <p class="text-center">List of Lifting Loose Gears</p>
        </div>
        </div>
      </div>
    </div>
