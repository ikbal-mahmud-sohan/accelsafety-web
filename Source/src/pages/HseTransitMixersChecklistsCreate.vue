...
const submitForm = async () => {
   formData.transit_mixer_des_1 = 'Transit mixer should be physically in good condition';
   formData.transit_mixer_des_2 = 'No damage in tire (Bolts, crack, cuts & air pressure, etc)';
   formData.transit_mixer_des_3 = 'Registration number should be written.';
   formData.transit_mixer_des_4 = 'Head & tail light and indicators are in working condition';
   formData.transit_mixer_des_5 = 'Side mirror should be in good condition';
   formData.transit_mixer_des_6 = 'Wind shield/glass should be in proper condition';
   formData.transit_mixer_des_7 = 'Wiper should be in running condition';
   formData.transit_mixer_des_8 = 'Red triangle/reflective tape should be fixed in front of vehicle';
   formData.transit_mixer_des_9 = 'Rotatory part of secondary engine should be covered with fix guard';
   formData.transit_mixer_des_10 = 'Rotating part of gear box should be covered by fixed guard';
   formData.transit_mixer_des_11 = 'Inbuilt ladder should be proper with suitable guard';
   formData.transit_mixer_des_12 = 'Front & reverse horn.';
   formData.transit_mixer_des_13 = 'Fire extinguisher in operator cabin.';
   formData.transit_mixer_des_14 = 'Operator have valid and suitable license.';
   formData.transit_mixer_des_15 = 'First aid kit should be available.';
   formData.transit_mixer_des_16 = 'Normal break & emergency (hand) break should be in functional & operational condition.';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_transit_mixer_1 = ishvcomplied1.value;
  formData.is_transit_mixer_2 = ishvcomplied2.value;
  formData.is_transit_mixer_3 = ishvcomplied3.value;
  formData.is_transit_mixer_4 = ishvcomplied4.value;
  formData.is_transit_mixer_5 = ishvcomplied5.value;
  formData.is_transit_mixer_6 = ishvcomplied6.value;
  formData.is_transit_mixer_7 = ishvcomplied7.value;
  formData.is_transit_mixer_8 = ishvcomplied8.value;
  formData.is_transit_mixer_9 = ishvcomplied9.value;
  formData.is_transit_mixer_10 = ishvcomplied10.value;
  formData.is_transit_mixer_11 = ishvcomplied11.value;
  formData.is_transit_mixer_12 = ishvcomplied12.value;
  formData.is_transit_mixer_13 = ishvcomplied13.value;
  formData.is_transit_mixer_14 = ishvcomplied14.value;
  formData.is_transit_mixer_15 = ishvcomplied15.value;
  formData.is_transit_mixer_16 = ishvcomplied16.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/transit-mixers-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-transit-mixers-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">TRANSIT MIXER</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> TRANSIT MIXER
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Transit mixer should be physically in good condition
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_1" class="w-full" type="text" name="transit_mixer_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_2" class="w-full" type="text" name="transit_mixer_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_3" class="w-full" type="text" name="transit_mixer_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_4" class="w-full" type="text" name="transit_mixer_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div>            
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_5" class="w-full" type="text" name="transit_mixer_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_6" class="w-full" type="text" name="transit_mixer_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div>              
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_7" class="w-full" type="text" name="transit_mixer_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_8" class="w-full" type="text" name="transit_mixer_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_9" class="w-full" type="text" name="transit_mixer_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Rotating part of gear box should be covered by fixed guard</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_10" class="w-full" type="text" name="transit_mixer_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Inbuilt ladder should be proper with suitable guard</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.transit_mixer_remarks_11" class="w-full" type="text" name="transit_mixer_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2" src="../assets/images/additional/TRANSITMIXER.png" alt="">
          </div>
          <div class="mt-5">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the TRANSIT MIXER report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">TRANSIT MIXER success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">TRANSIT MIXER failed!</div>
