...
const fetchData = async () => {
  try {
   let  url = config.baseURL+'/api/v1/emergency-alarm-visible';
...
const deleteData = async (sID:string) => {
  try {
    let url = config.baseURL+"/api/v1/emergency-alarm-visible/delete/"+sID;
...
<template>
  <h2 class="mt-10 text-lg font-medium intro-y">Emergency Alarm Visible List</h2>
          ...
          <Table.Tr v-for="(report, index) in state.emergencyAlarm" :key="index" class="intro-x">
            ...
            >
              <div class="flex items-center justify-center">
                ...
                <router-link :to="{name:'hse-emergency-alarm-visible-full', params:{id:report.id} }" class="flex items-center mr-3 text-nowrap">
                  <Lucide icon="CheckSquare" class="w-4 h-4 mr-1 " />
                  Update
                </router-link>
                <router-link :to="{name:'hse-emergency-alarm-visible-edit', params:{id:report.id} }" class="flex items-center mr-3 text-nowrap">
