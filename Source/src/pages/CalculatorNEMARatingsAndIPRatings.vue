...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium"> Calculate NEMA Ratings and IP Ratings Equivalency</h2>
  </div>
  <div class="grid grid-cols-11 pb-20 mt-5 gap-x-6">
    ...
    >
      <div class="flex items-center">
        ...
        <span>
          Note: This calculator is for educational purposes only. Always follow manufacturer guidelines for accurate NEMA Ratings and IP Ratings Equivalency values.
          <a
    ...
    <div class="col-span-11 intro-y 2xl:col-span-9">
      ...
      <div class="p-5 mt-5 intro-y box">
        ...
        >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> NEMA / IP Ratings Equivalency Calculator
          </div>
          <div class="mt-5">
            <FormInline class="flex flex-col flex-wrap mt-2 xl:flex-row first:mt-0 first:pt-0">
              <FormLabel class="xl:w-64 xl:!mr-10">
                <div class="text-left">
                  <div class="flex items-center pr-4">
                    <div class="font-medium text-sm text-nowrap flex mt-6 xl:mt-3.5">Select Input Type:
                        <TooltipIcon tooltipText="Select Input" />
                    </div>
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <select class="w-full border border-gray-300 rounded-lg py-3 text-sm">
                  <option value="NEMA Rating" >NEMA Rating</option>
                  <option value="IP Equivalent" >IP Equivalent</option>
                </select>
                  <div class="flex justify-between">
            ...
            <FormInline class="flex flex-col flex-wrap mt-2 xl:flex-row first:mt-0 first:pt-0">
              <FormLabel class="xl:w-64 xl:!mr-10">
                <div class="text-left">
                  <div class="flex items-center pr-4">
                    <div class="font-medium text-sm text-wrap md:text-nowrap flex mt-6 xl:mt-3.5">Select Rating:
                        <TooltipIcon tooltipText="Select Rating" />
                    </div>
                    <!-- <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md mt-6 xl:mt-3.5">
                      Required
                    </div> -->
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <select class="w-full border border-gray-300 rounded-lg py-3 text-sm">
                  ...
                  <option value="NEMA 2" >NEMA 2</option>
                  <option value="NEMA 3" >NEMA 3</option>
                  <option value="NEMA 4" >NEMA 4</option>
                  <option value="NEMA 5" >NEMA 5</option>
                  <option value="NEMA 6" >NEMA 6</option>
                  <option value="NEMA 12" >NEMA 12</option>
                  <option value="NEMA 13" >NEMA 13</option>
                  <option value="NEMA 3R" >NEMA 3R</option>
                  <option value="NEMA 3S" >NEMA 3S</option>
                  <option value="NEMA 4X" >NEMA 4X</option>
                  <option value="NEMA 6P" >NEMA 6P</option>
                  <option value="NEMA 12K" >NEMA 12K</option>
                </select>
                  <div class="flex justify-between">
                    <p class="text-right mt-2 w-full"> Required</p>
                </div>
      ...
      <div class="relative p-5 mt-10 border rounded-md bg-success/20 dark:bg-darkmode-600 border-success dark:border-0">
          ...
          <div class="mt-2 text-xs leading-relaxed text-slate-600 dark:text-slate-500">
            <div class="mt-1 text-sm"><strong> NEMA Definition:</strong> Enclosures constructed for indoor use to provide protection against contact with enclosed equipment, falling dirt, circulating dust, lint, fibers, and light splashing of liquids.</div>
            <div class="mt-1 text-sm"><strong> IP Equivalent:</strong> IP52</div>
            <div class="mt-1 text-sm"><strong> IP Definition:</strong> Protected against dust - Limited ingress (no harmful deposit) and direct sprays of water up to 15° from vertical. </div>
          </div>
      </div>
      <!-- results:end -->
    </div>
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <a href="">NEMA / IP Ratings Equivalency Calculator</a>
          </li>
          <li
