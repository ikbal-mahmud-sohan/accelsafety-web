...
<template>
  <h2 class="mt-10 text-lg font-medium intro-y">Accel Safety Word List</h2>
  <div class="grid grid-cols-12 gap-6 mt-5">
    <div class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap">
      <!-- <Button variant="primary" class="mr-2 shadow-md">
        Add New Accident
      </Button> -->
      <router-link :to="{ name: 'accel-safety-words-create' }">
        <Button variant="primary" class="mr-2 shadow-md">
          Add Accel Safety Word
        </Button>
      </router-link>
      <Menu>
    ...
    <div class="col-span-12 overflow-auto intro-y ">
      <Table class="border-spacing-y-[10px] border-separate -mt-2">
        <Table.Thead>
          <Table.Tr>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">Number</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">Version</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">Title</Table.Th>
            <Table.Th class="text-left border-b-0 whitespace-nowrap uppercase">Records Date</Table.Th>
          ...
          <Table.Tr v-for="(report, index) in state.viewData" :key="index" class="intro-x">
            ...
            >
              <div class="flex items-center justify-center">
                <router-link :to="{name:'accel-safety-words-view', params:{id:report.id} }" class="flex items-center mr-3">
