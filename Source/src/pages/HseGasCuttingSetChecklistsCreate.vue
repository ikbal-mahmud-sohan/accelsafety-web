...
const submitForm = async () => {
   formData.gas_cutting_des_1 = 'Cylinder should be kept in trolley';
   formData.gas_cutting_des_2 = 'Always keep in upright position';
   formData.gas_cutting_des_3 = 'Properly secured';
   formData.gas_cutting_des_4 = 'Valve protection cap';
   formData.gas_cutting_des_5 = 'Regulator should be free from any defect';
   formData.gas_cutting_des_6 = 'Pressure gauge should be in proper condition';
   formData.gas_cutting_des_7 = 'Provide flash back arrestor';
   formData.gas_cutting_des_8 = 'Provide industrial clip';
   formData.gas_cutting_des_9 = 'Hose condition should be good with colour coded';
   formData.gas_cutting_des_10 = 'Joint should be firm and free from defect, e.g., oily, rust & leakage, etc';
   formData.gas_cutting_des_11 = 'Torch should be in good condition';
   formData.gas_cutting_des_12 = 'Use proper PPEs for the Job, e.g., Leather hand gloves & safety goggles, etc';
   formData.gas_cutting_des_13 = 'Keep fire extinguisher at working place';
   formData.gas_cutting_des_14 = 'Provide booth, made by fire retardant material (if required)';
   formData.gas_cutting_des_15 = 'Work carried out by competent person';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_gas_cutting_1 = ishvcomplied1.value;
  formData.is_gas_cutting_2 = ishvcomplied2.value;
  formData.is_gas_cutting_3 = ishvcomplied3.value;
  formData.is_gas_cutting_4 = ishvcomplied4.value;
  formData.is_gas_cutting_5 = ishvcomplied5.value;
  formData.is_gas_cutting_6 = ishvcomplied6.value;
  formData.is_gas_cutting_7 = ishvcomplied7.value;
  formData.is_gas_cutting_8 = ishvcomplied8.value;
  formData.is_gas_cutting_9 = ishvcomplied9.value;
  formData.is_gas_cutting_10 = ishvcomplied10.value;
  formData.is_gas_cutting_11 = ishvcomplied11.value;
  formData.is_gas_cutting_12 = ishvcomplied12.value;
  formData.is_gas_cutting_13 = ishvcomplied13.value;
  formData.is_gas_cutting_14 = ishvcomplied14.value;
  formData.is_gas_cutting_15 = ishvcomplied15.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/gas-cutting-set-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'gas-cutting-set-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Gas Cutting Set</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Gas Cutting Set
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Cylinder should be kept in trolley
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_1" class="w-full" type="text" name="gas_cutting_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Always keep in upright position</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_2" class="w-full" type="text" name="gas_cutting_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Properly secured</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_3" class="w-full" type="text" name="gas_cutting_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Valve protection cap</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_4" class="w-full" type="text" name="gas_cutting_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Regulator should be free from any defect</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_5" class="w-full" type="text" name="gas_cutting_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Pressure gauge should be in proper condition</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_6" class="w-full" type="text" name="gas_cutting_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Provide flash back arrestor</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_7" class="w-full" type="text" name="gas_cutting_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Provide industrial clip</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_8" class="w-full" type="text" name="gas_cutting_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Hose condition should be good with colour coded</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_9" class="w-full" type="text" name="gas_cutting_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Joint should be firm and free from defect, e.g., oily, rust & leakage, etc</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_10" class="w-full" type="text" name="gas_cutting_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Torch should be in good condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_11" class="w-full" type="text" name="gas_cutting_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Use proper PPEs for the Job, e.g., Leather hand gloves & safety goggles, etc</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_12" class="w-full" type="text" name="gas_cutting_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Keep fire extinguisher at working place</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_13" class="w-full" type="text" name="gas_cutting_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Provide booth, made by fire retardant material (if required)</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_14" class="w-full" type="text" name="gas_cutting_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Work carried out by competent person</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.gas_cutting_remarks_15" class="w-full" type="text" name="gas_cutting_remarks_15" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/GasCuttingSet.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Gas Cutting Set report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Gas Cutting Set success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Gas Cutting Set failed!</div>
