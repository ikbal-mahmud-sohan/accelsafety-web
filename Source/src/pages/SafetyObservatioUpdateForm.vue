...
<template>
  ...
  <div class="grid grid-cols-11 pb-20 mt-5 gap-x-6">
          ...
          <div class="mt-5">
            <FormInline class="flex flex-wrap items-center pt-5 mt-5 xl:flex-row first:mt-0 first:pt-0">
              <FormLabel class="xl:w-64 xl:!mr-10">
                <div class="text-left">
                  <div class="flex items-center">
                    <div class="font-medium">Corrective Image</div>
                    <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">
                      Required
                    </div>
                  </div>
                  <div class="mt-3 text-xs leading-relaxed text-slate-500">
                    Images showing the corrective actions taken.
                  </div>
                </div>
              </FormLabel>
              <div class="flex-1 w-full mt-3 xl:mt-0">
    ...
    <!-- Display Uploaded File Names -->
                  <div v-if="formData.corrective_image.length" class="w-full space-y-2">
                    <div
                      v-for="(file, index) in formData.corrective_image"
                      :key="index"
                ...
                <div class="flex justify-between">
                  ...
                  <div v-for="(error, index) in validate.corrective_image.$errors" :key="index" class="mt-2 text-danger whitespace-nowrap">
                    {{ error.$message }}
                  </div>
                </template>
