...
const ishvcomplied17 = ref("");
const ishvcomplied18 = ref("");
const ishvcomplied19 = ref("");
const fitUnfit = ref("");
const isgeccon = ref("");
...
const submitForm = async () => {
   formData.tower_crane_des_1 = 'Tower crane should be physically in good condition, free from defects';
   formData.tower_crane_des_2 = 'Foundation should be provided as per design';
   formData.tower_crane_des_3 = 'Operator cabin should be in good condition, equipped with wind glasses and wireless communication';
   formData.tower_crane_des_4 = 'Safe working load should be marked';
   formData.tower_crane_des_5 = 'Counter weight should be properly fixed';
   formData.tower_crane_des_6 = 'Hydraulic cylinder, hoses should be in good condition and free from leakage';
   formData.tower_crane_des_7 = 'Trolley condition should be good';
   formData.tower_crane_des_8 = 'Over hoist limit switch should be in working state';
   formData.tower_crane_des_9 = 'Limit switch should be provided for trolley motor';
   formData.tower_crane_des_10 = 'Sling should be free from defects';
   formData.tower_crane_des_11 = 'Safety latch should be in hook';
   formData.tower_crane_des_12 = 'Power cable should be free from damages and connection taken through industrial plug';
   formData.tower_crane_des_13 = 'Tower crane should be grounded as per IS 3043:1987';
   formData.tower_crane_des_14 = 'Safe load indicator should be in working condition';
   formData.tower_crane_des_15 = 'Fire extinguisher in operator cabin';
   formData.tower_crane_des_16 = 'Operator have suitable license/experience certificate';
   formData.tower_crane_des_17 = 'First aid kit should be available.';
   formData.tower_crane_des_18 = 'Tower crane should be physically good & should have valid TPI';
   formData.tower_crane_des_19 = 'Anemometer should be in working condition';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_tower_crane_1 = ishvcomplied1.value;
  formData.is_tower_crane_2 = ishvcomplied2.value;
  formData.is_tower_crane_3 = ishvcomplied3.value;
  formData.is_tower_crane_4 = ishvcomplied4.value;
  formData.is_tower_crane_5 = ishvcomplied5.value;
  formData.is_tower_crane_6 = ishvcomplied6.value;
  formData.is_tower_crane_7 = ishvcomplied7.value;
  formData.is_tower_crane_8 = ishvcomplied8.value;
  formData.is_tower_crane_9 = ishvcomplied9.value;
  formData.is_tower_crane_10 = ishvcomplied10.value;
  formData.is_tower_crane_11 = ishvcomplied11.value;
  formData.is_tower_crane_12 = ishvcomplied12.value;
  formData.is_tower_crane_13 = ishvcomplied13.value;
  formData.is_tower_crane_14 = ishvcomplied14.value;
  formData.is_tower_crane_15 = ishvcomplied15.value;
  formData.is_tower_crane_16 = ishvcomplied16.value;
  formData.is_tower_crane_17 = ishvcomplied17.value;
  formData.is_tower_crane_18 = ishvcomplied18.value;
  formData.is_tower_crane_19 = ishvcomplied19.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/tower-crane-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-tower-crane-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Tower Crane Create</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Tower Crane Create
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Tower crane should be physically in good condition, free from defects
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_1" class="w-full" type="text" name="tower_crane_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Foundation should be provided as per design</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_2" class="w-full" type="text" name="tower_crane_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operator cabin should be in good condition, equipped with wind glasses and wireless communication</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_3" class="w-full" type="text" name="tower_crane_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Safe working load should be marked</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_4" class="w-full" type="text" name="tower_crane_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Counter weight should be properly fixed</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_5" class="w-full" type="text" name="tower_crane_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Hydraulic cylinder, hoses should be in good condition and free from leakage</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_6" class="w-full" type="text" name="tower_crane_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Trolley condition should be good</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_7" class="w-full" type="text" name="tower_crane_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Over hoist limit switch should be in working state</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_8" class="w-full" type="text" name="tower_crane_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Limit switch should be provided for trolley motor</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_9" class="w-full" type="text" name="tower_crane_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Sling should be free from defects</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_10" class="w-full" type="text" name="tower_crane_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_11" class="w-full" type="text" name="tower_crane_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_12" class="w-full" type="text" name="tower_crane_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Tower crane should be grounded as per IS 3043:1987</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_13" class="w-full" type="text" name="tower_crane_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Safe load indicator should be in working condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_14" class="w-full" type="text" name="tower_crane_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_15" class="w-full" type="text" name="tower_crane_remarks_15" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operator have suitable license/experience certificate</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_16" class="w-full" type="text" name="tower_crane_remarks_16" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">First aid kit should be available.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="flex flex-col justify-between mt-2 sm:flex-row">
                          <FormCheck class="mr-2">
                            <FormCheck.Input id="radio-switchq-1" v-model="ishvcomplied17" type="radio" name="hseLadder17" value="Yes" />
                            <FormCheck.Label htmlFor="radio-switchq-1">
                                Yes
                            </FormCheck.Label>
                        </FormCheck>
                        <FormCheck class="mr-2">
                            <FormCheck.Input id="radio-switchq-2" v-model="ishvcomplied17" type="radio" name="hseLadder17" value="No" />
                            <FormCheck.Label htmlFor="radio-switchq-2">
                                No
                            </FormCheck.Label>
                        </FormCheck>
                        <FormCheck class="">
                            <FormCheck.Input id="radio-switchq-3" v-model="ishvcomplied17" type="radio" name="hseLadder17" value="" />
                            <FormCheck.Label htmlFor="radio-switchq-3">
                                N/A
                            </FormCheck.Label>
                        </FormCheck>
                      </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_17" class="w-full" type="text" name="tower_crane_remarks_17" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="flex flex-col justify-between mt-2 sm:flex-row">
                          <FormCheck class="mr-2">
                            <FormCheck.Input id="radio-switchr-1" v-model="ishvcomplied18" type="radio" name="hseLadder18" value="Yes" />
                            <FormCheck.Label htmlFor="radio-switchr-1">
                                Yes
                            </FormCheck.Label>
                        </FormCheck>
                        <FormCheck class="mr-2">
                            <FormCheck.Input id="radio-switchr-2" v-model="ishvcomplied18" type="radio" name="hseLadder18" value="No" />
                            <FormCheck.Label htmlFor="radio-switchr-2">
                                No
                            </FormCheck.Label>
                        </FormCheck>
                        <FormCheck class="">
                            <FormCheck.Input id="radio-switchr-3" v-model="ishvcomplied18" type="radio" name="hseLadder18" value="" />
                            <FormCheck.Label htmlFor="radio-switchr-3">
                                N/A
                            </FormCheck.Label>
                        </FormCheck>
                      </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_18" class="w-full" type="text" name="tower_crane_remarks_18" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Anemometer should be in working condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="flex flex-col justify-between mt-2 sm:flex-row">
                          <FormCheck class="mr-2">
                            <FormCheck.Input id="radio-switchs-1" v-model="ishvcomplied19" type="radio" name="hseLadder19" value="Yes" />
                            <FormCheck.Label htmlFor="radio-switchs-1">
                                Yes
                            </FormCheck.Label>
                        </FormCheck>
                        <FormCheck class="mr-2">
                            <FormCheck.Input id="radio-switchs-2" v-model="ishvcomplied19" type="radio" name="hseLadder19" value="No" />
                            <FormCheck.Label htmlFor="radio-switchs-2">
                                No
                            </FormCheck.Label>
                        </FormCheck>
                        <FormCheck class="">
                            <FormCheck.Input id="radio-switchs-3" v-model="ishvcomplied19" type="radio" name="hseLadder19" value="" />
                            <FormCheck.Label htmlFor="radio-switchs-3">
                                N/A
                            </FormCheck.Label>
                        </FormCheck>
                      </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.tower_crane_remarks_19" class="w-full" type="text" name="tower_crane_remarks_19" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/TOWER CRANE.png" alt="">
          </div>
          <div class="mt-5">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Tower Crane Create report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Tower Crane Create success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Tower Crane Create failed!</div>
