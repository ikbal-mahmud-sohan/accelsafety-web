    ...
    if (validate.value.$invalid) {
      FailedPopUp();
            ...
            try {
                ...
                ? `${config.baseURL}/api/v1/emergency-alarm-audible/update/${state.entryId}`
                : `${config.baseURL}/api/v1/emergency-alarm-audible`;
              ...
              console.log("emgergencyAlarm_res: ", response.data);
              router.push({ name: 'hse-emergency-alarm-audible-list' });
...
const fetchEntryData = async (id: string) => {
  try {
    const response = await axios.get(`${config.baseURL}/api/v1/emergency-alarm-audible/edit/${id}`, {
      headers: {
        'Authorization': state.token,
      },
    });
    ...
    console.log('Fetched emgergencyAlarm Data:', data);
...
<template>
  <div class="grid grid-cols-12 gap-6 mt-5">
    ...
    <div class="col-span-12   overflow-y-auto ">
        <div class="risk-form-head">
            <div class="py-4 bg-theme-1">
                <p class=" text-base font-semibold uppercase text-center text-white">{{ state.isEditMode ? 'Emergency Alarm Audible FORM Edit' : 'Emergency Alarm Audible FORM' }}</p>
            </div>
   ...
   <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium text-nowrap">Emergency Alarm Audible {{ state.isEditMode ? 'Editing' : 'Create' }} success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium text-nowrap">Emergency Alarm Audible {{ state.isEditMode ? 'Edit' : 'Create' }} failed!</div>
