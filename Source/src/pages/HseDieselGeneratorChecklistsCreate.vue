...
const submitForm = async () => {
   formData.diesel_generator_des_1 = 'Physical condition of DG should be good';
   formData.diesel_generator_des_2 = 'Door of DG should be in good condition, so that rotatory part of machine could cover.';
   formData.diesel_generator_des_3 = 'Display panel should be in good condition';
   formData.diesel_generator_des_4 = 'Emergency stop button should be mushroom headed with red colour';
   formData.diesel_generator_des_5 = 'DG should be grounded as per IS 3043:1987';
   formData.diesel_generator_des_6 = 'Power supply panel provided with ELCB/RCCB/MCB';
   formData.diesel_generator_des_7 = 'Spark arrestor should be installed, if DG is operating in flammable atmosphere';
   formData.diesel_generator_des_8 = 'Diesel tank should free from leakage';
   formData.diesel_generator_des_9 = 'DG should be keep on aggregate/gravel stone';
   formData.diesel_generator_des_10 = 'Keep CO2, BCP fire extinguisher/sand bucket near DG';
   formData.diesel_generator_des_11 = 'Fitness and pollution certificate should be taken from competent authority';
   formData.diesel_generator_des_12 = 'DG operated by competent person';
   formData.diesel_generator_des_13 = 'Spill observant kit or drip tray available';
   formData.diesel_generator_des_14 = 'Insulated rubber mat available';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_diesel_generator_1 = ishvcomplied1.value;
  formData.is_diesel_generator_2 = ishvcomplied2.value;
  formData.is_diesel_generator_3 = ishvcomplied3.value;
  formData.is_diesel_generator_4 = ishvcomplied4.value;
  formData.is_diesel_generator_5 = ishvcomplied5.value;
  formData.is_diesel_generator_6 = ishvcomplied6.value;
  formData.is_diesel_generator_7 = ishvcomplied7.value;
  formData.is_diesel_generator_8 = ishvcomplied8.value;
  formData.is_diesel_generator_9 = ishvcomplied9.value;
  formData.is_diesel_generator_10 = ishvcomplied10.value;
  formData.is_diesel_generator_11 = ishvcomplied11.value;
  formData.is_diesel_generator_12 = ishvcomplied12.value;
  formData.is_diesel_generator_13 = ishvcomplied13.value;
  formData.is_diesel_generator_14 = ishvcomplied14.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/diesel-generator-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-diesel-generator-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Diesel Generator</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Diesel Generator
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Physical condition of DG should be good
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_1" class="w-full" type="text" name="diesel_generator_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Door of DG should be in good condition, so that rotatory part of machine could cover.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_2" class="w-full" type="text" name="diesel_generator_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Display panel should be in good condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_3" class="w-full" type="text" name="diesel_generator_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Emergency stop button should be mushroom headed with red colour</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_4" class="w-full" type="text" name="diesel_generator_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">DG should be grounded as per IS 3043:1987</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_5" class="w-full" type="text" name="diesel_generator_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Power supply panel provided with ELCB/RCCB/MCB</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_6" class="w-full" type="text" name="diesel_generator_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Spark arrestor should be installed, if DG is operating in flammable atmosphere</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_7" class="w-full" type="text" name="diesel_generator_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Diesel tank should free from leakage</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_8" class="w-full" type="text" name="diesel_generator_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">DG should be keep on aggregate/gravel stone</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_9" class="w-full" type="text" name="diesel_generator_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Keep CO2, BCP fire extinguisher/sand bucket near DG</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_10" class="w-full" type="text" name="diesel_generator_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Fitness and pollution certificate should be taken from competent authority</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_11" class="w-full" type="text" name="diesel_generator_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">DG operated by competent person</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_12" class="w-full" type="text" name="diesel_generator_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Spill observant kit or drip tray available</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_13" class="w-full" type="text" name="diesel_generator_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Insulated rubber mat available</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.diesel_generator_remarks_14" class="w-full" type="text" name="diesel_generator_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/17DieselGenerato.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Diesel Generator report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Diesel Generator success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Diesel Generator failed!</div>
