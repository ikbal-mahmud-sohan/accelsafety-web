...
const submitForm = async () => {
   formData.water_tanker_des_1 = 'Physical condition of vehicle is good and free from leakage';
   formData.water_tanker_des_2 = 'No damage in tire (Bolts, crack, cuts & air pressure, etc.)';
   formData.water_tanker_des_3 = 'Side mirror should be in good condition';
   formData.water_tanker_des_4 = 'Head & tail light and indicators are in working condition.';
   formData.water_tanker_des_5 = 'Wiper should be in running condition';
   formData.water_tanker_des_6 = 'Wind shield/glass should be in proper condition';
   formData.water_tanker_des_7 = 'Seatbelt should be available';
   formData.water_tanker_des_8 = 'Reflective tape should be fixed in front of vehicle';
   formData.water_tanker_des_9 = 'Registration number should be written';
   formData.water_tanker_des_10 = 'Normal break & emergency (hand) break should be in functional & operational condition';
   formData.water_tanker_des_11 = 'Front & reverse horn';
   formData.water_tanker_des_12 = 'Fire extinguisher in operator cabin';
   formData.water_tanker_des_13 = 'Operator have valid and suitable license';
   formData.water_tanker_des_14 = 'First aid kit should be available';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_water_tanker_1 = ishvcomplied1.value;
  formData.is_water_tanker_2 = ishvcomplied2.value;
  formData.is_water_tanker_3 = ishvcomplied3.value;
  formData.is_water_tanker_4 = ishvcomplied4.value;
  formData.is_water_tanker_5 = ishvcomplied5.value;
  formData.is_water_tanker_6 = ishvcomplied6.value;
  formData.is_water_tanker_7 = ishvcomplied7.value;
  formData.is_water_tanker_8 = ishvcomplied8.value;
  formData.is_water_tanker_9 = ishvcomplied9.value;
  formData.is_water_tanker_10 = ishvcomplied10.value;
  formData.is_water_tanker_11 = ishvcomplied11.value;
  formData.is_water_tanker_12 = ishvcomplied12.value;
  formData.is_water_tanker_13 = ishvcomplied13.value;
  formData.is_water_tanker_14 = ishvcomplied14.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/water-tanker-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'water-tanker-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Water Tanker</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Water Tanker
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_1" class="w-full" type="text" name="water_tanker_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_2" class="w-full" type="text" name="water_tanker_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_3" class="w-full" type="text" name="water_tanker_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_4" class="w-full" type="text" name="water_tanker_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_5" class="w-full" type="text" name="water_tanker_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_6" class="w-full" type="text" name="water_tanker_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_7" class="w-full" type="text" name="water_tanker_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_8" class="w-full" type="text" name="water_tanker_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_9" class="w-full" type="text" name="water_tanker_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_10" class="w-full" type="text" name="water_tanker_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_11" class="w-full" type="text" name="water_tanker_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_12" class="w-full" type="text" name="water_tanker_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_13" class="w-full" type="text" name="water_tanker_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.water_tanker_remarks_14" class="w-full" type="text" name="water_tanker_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/43WaterTanker.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Water Tanker report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Water Tanker success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Water Tanker failed!</div>
