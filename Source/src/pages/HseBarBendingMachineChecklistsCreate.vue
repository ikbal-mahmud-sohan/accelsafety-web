...
const submitForm = async () => {
   formData.bar_bending_des_1 = 'Physical condition of body should be good & sound';
   formData.bar_bending_des_2 = 'Electrical connection should be taken through industrial plug in proper manner';
   formData.bar_bending_des_3 = 'Power cable should be free from damages';
   formData.bar_bending_des_4 = 'Operating switch should be free from defects, e.g., uninsulated & broken, etc.';
   formData.bar_bending_des_5 = 'On/off or other switches should free from defects, e.g., uninsulated & broken, etc.';
   formData.bar_bending_des_6 = 'Emergency stop button should be mushroom headed with red colour';
   formData.bar_bending_des_7 = 'Bar support should be properly fitted with machine';
   formData.bar_bending_des_8 = 'Pins should be free from loose fitting';
   formData.bar_bending_des_9 = 'Machine should be grounded as per IS 3043:1987';
   formData.bar_bending_des_10 = 'Machine should be operated by competent person';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_bar_bending_1 = ishvcomplied1.value;
  formData.is_bar_bending_2 = ishvcomplied2.value;
  formData.is_bar_bending_3 = ishvcomplied3.value;
  formData.is_bar_bending_4 = ishvcomplied4.value;
  formData.is_bar_bending_5 = ishvcomplied5.value;
  formData.is_bar_bending_6 = ishvcomplied6.value;
  formData.is_bar_bending_7 = ishvcomplied7.value;
  formData.is_bar_bending_8 = ishvcomplied8.value;
  formData.is_bar_bending_9 = ishvcomplied9.value;
  formData.is_bar_bending_10 = ishvcomplied10.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/bar-bending-machine-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-bar-bending-machine-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Bar Bending Machine</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Bar Bending Machine
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_1" class="w-full" type="text" name="bar_bending_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Electrical connection should be taken through industrial plug in proper manner</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_2" class="w-full" type="text" name="bar_bending_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Power cable should be free from damages</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_3" class="w-full" type="text" name="bar_bending_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operating switch should be free from defects, e.g., uninsulated & broken, etc.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_4" class="w-full" type="text" name="bar_bending_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">On/off or other switches should free from defects, e.g., uninsulated & broken, etc.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_5" class="w-full" type="text" name="bar_bending_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_6" class="w-full" type="text" name="bar_bending_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Bar support should be properly fitted with machine</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_7" class="w-full" type="text" name="bar_bending_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Pins should be free from loose fitting</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_8" class="w-full" type="text" name="bar_bending_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_9" class="w-full" type="text" name="bar_bending_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Machine should be operated by competent person</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.bar_bending_remarks_10" class="w-full" type="text" name="bar_bending_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div>       
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/Bar_Bending_Machine.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Bar Bending Machine report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Bar Bending Machine success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Bar Bending Machine failed!</div>
