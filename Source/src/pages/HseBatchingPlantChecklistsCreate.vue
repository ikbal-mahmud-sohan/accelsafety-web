...
const submitForm = async () => {
   formData.batching_plant_des_1 = 'Physical condition of body should be good & sound.';
   formData.batching_plant_des_2 = 'Staircase should be in good condition';
   formData.batching_plant_des_3 = 'Operator cabin should be free from dust accumulation';
   formData.batching_plant_des_4 = 'Metal mesh should be provided on the aggregate and sand hopper';
   formData.batching_plant_des_5 = 'Conveyor belt should be guarded, covered and pull cord should be installed';
   formData.batching_plant_des_6 = 'Mixing chamber should be closed';
   formData.batching_plant_des_7 = 'Monkey ladder with cage should be available';
   formData.batching_plant_des_8 = 'Guardrail system should be in good condition';
   formData.batching_plant_des_9 = 'Lightening arrestor should be installed';
   formData.batching_plant_des_10 = 'All part of machine should be grounded';
   formData.batching_plant_des_11 = 'Power cable should be free from defect and connection taken through MCB and RCCB';
   formData.batching_plant_des_12 = 'Fire extinguisher in operator cabin';
   formData.batching_plant_des_13 = 'Operated by only authorized operator';
   formData.batching_plant_des_14 = 'Emergency switch should be in working condition.';
   formData.batching_plant_des_15 = 'Aviation light should be in working condition';
   formData.batching_plant_des_16 = 'Hooter is in working condition';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_batching_plant_1 = ishvcomplied1.value;
  formData.is_batching_plant_2 = ishvcomplied2.value;
  formData.is_batching_plant_3 = ishvcomplied3.value;
  formData.is_batching_plant_4 = ishvcomplied4.value;
  formData.is_batching_plant_5 = ishvcomplied5.value;
  formData.is_batching_plant_6 = ishvcomplied6.value;
  formData.is_batching_plant_7 = ishvcomplied7.value;
  formData.is_batching_plant_8 = ishvcomplied8.value;
  formData.is_batching_plant_9 = ishvcomplied9.value;
  formData.is_batching_plant_10 = ishvcomplied10.value;
  formData.is_batching_plant_11 = ishvcomplied11.value;
  formData.is_batching_plant_12 = ishvcomplied12.value;
  formData.is_batching_plant_13 = ishvcomplied13.value;
  formData.is_batching_plant_14 = ishvcomplied14.value;
  formData.is_batching_plant_15 = ishvcomplied15.value;
  formData.is_batching_plant_16 = ishvcomplied16.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/batching-plant-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'batching-plant-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Batching Plant</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Batching Plant
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_1" class="w-full" type="text" name="batching_plant_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Staircase should be in good condition</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_2" class="w-full" type="text" name="batching_plant_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operator cabin should be free from dust accumulation</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_3" class="w-full" type="text" name="batching_plant_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Metal mesh should be provided on the aggregate and sand hopper</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_4" class="w-full" type="text" name="batching_plant_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Conveyor belt should be guarded, covered and pull cord should be installed</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_5" class="w-full" type="text" name="batching_plant_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Mixing chamber should be closed</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_6" class="w-full" type="text" name="batching_plant_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Monkey ladder with cage should be available</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_7" class="w-full" type="text" name="batching_plant_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Guardrail system should be in good condition</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_8" class="w-full" type="text" name="batching_plant_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Lightening arrestor should be installed</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_9" class="w-full" type="text" name="batching_plant_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">All part of machine should be grounded</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_10" class="w-full" type="text" name="batching_plant_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Power cable should be free from defect and connection taken through MCB and RCCB</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_11" class="w-full" type="text" name="batching_plant_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_12" class="w-full" type="text" name="batching_plant_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Operated by only authorized operator</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_13" class="w-full" type="text" name="batching_plant_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Emergency switch should be in working condition.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_14" class="w-full" type="text" name="batching_plant_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Aviation light should be in working condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_15" class="w-full" type="text" name="batching_plant_remarks_15" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Hooter is in working condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.batching_plant_remarks_16" class="w-full" type="text" name="batching_plant_remarks_16" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/32BatchingPlant.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Batching Plant report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Batching Plant success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Batching Plant failed!</div>
