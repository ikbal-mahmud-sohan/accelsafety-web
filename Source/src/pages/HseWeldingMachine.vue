...
<template>
  ...
  <div class="pb-8">
    <h2 class="text-2xl font-medium intro-y text-center uppercase">Welding Machine</h2>
  </div>
  <div class="flex flex-wrap bg-theme-1 bg-opacity-20 px-4 py-4 rounded-md shadow-md">
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        ...
        <div class="py-1">
          <p class="text-center">Welding Machine List</p>
        </div>
        </div>
      </div>
    </div>
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        ...
        <div class="py-1">
          <p class="text-center">Welding Machine Create</p>
        </div>
        </div>
      </div>
    </div>
