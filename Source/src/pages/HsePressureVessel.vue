...
<template>
  ...
  <div class="pb-8">
    <h2 class="text-2xl font-medium intro-y text-center uppercase">Pressure Vessel Management Procedure</h2>
  </div>
  <div class="flex flex-wrap bg-theme-1 bg-opacity-20 px-4 py-4 rounded-md shadow-md">
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        <div class="border py-2">
          ...
          <router-link :to="{ name: 'hse-pressure-vessel-doc' }">
        ...
        <div class="py-1">
          <p class="text-center">Pressure Vessel Management Procedure documentation</p>
        </div>
        </div>
      </div>
    </div>
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        <div class="border py-2">
          <div class="flex justify-center items-center p-4">
          <router-link :to="{ name: 'hse-list-pressure-vessels' }">
            <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/2.Hazard.png" alt="">
            </div>
          </router-link>
        ...
        <div class="py-1">
          <p class="text-center">Master List of Pressure Vessels</p>
        </div>
        </div>
      </div>
    </div>
    <div class="w-full lg:w-1/3">
      <div class="p-4">
        ...
        <div class="py-1">
          <p class="text-center">Master Pressure Vessels Create</p>
        </div>
        </div>
      </div>
    </div>
