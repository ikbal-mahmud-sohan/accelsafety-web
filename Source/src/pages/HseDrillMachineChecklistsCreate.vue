...
const submitForm = async () => {
   formData.drill_machine_des_1 = 'Drill machine should be in good and working condition';
   formData.drill_machine_des_2 = 'Power cable should be free from damages and connection taken through industrial plug';
   formData.drill_machine_des_3 = 'A flexible cord should be provided to keep cable free from damage';
   formData.drill_machine_des_4 = 'Dead man switch should be in working condition';
   formData.drill_machine_des_5 = 'Handle should be provided for better control';
   formData.drill_machine_des_6 = 'Drill bit should be in good condition and free from defect';
   formData.drill_machine_des_7 = 'Always use designated key for removing and changing drill bit';
   formData.drill_machine_des_8 = 'Drill machine should be double insulated otherwise grounded';
   formData.drill_machine_des_9 = 'Machine operated by competent person';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_drill_machine_1 = ishvcomplied1.value;
  formData.is_drill_machine_2 = ishvcomplied2.value;
  formData.is_drill_machine_3 = ishvcomplied3.value;
  formData.is_drill_machine_4 = ishvcomplied4.value;
  formData.is_drill_machine_5 = ishvcomplied5.value;
  formData.is_drill_machine_6 = ishvcomplied6.value;
  formData.is_drill_machine_7 = ishvcomplied7.value;
  formData.is_drill_machine_8 = ishvcomplied8.value;
  formData.is_drill_machine_9 = ishvcomplied9.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/drill-machine-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-drill-machine-checklists' });
                }
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Drill machine should be in good and working condition
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_1" class="w-full" type="text" name="drill_machine_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_2" class="w-full" type="text" name="drill_machine_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_3" class="w-full" type="text" name="drill_machine_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_4" class="w-full" type="text" name="drill_machine_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_5" class="w-full" type="text" name="drill_machine_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Drill bit should be in good condition and free from defect</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_6" class="w-full" type="text" name="drill_machine_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Always use designated key for removing and changing drill bit</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_7" class="w-full" type="text" name="drill_machine_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Drill machine should be double insulated otherwise grounded</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_8" class="w-full" type="text" name="drill_machine_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.drill_machine_remarks_9" class="w-full" type="text" name="drill_machine_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div>       
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/Drill_Machine.png" alt="">
          </div>
          <div class="mt-5">
