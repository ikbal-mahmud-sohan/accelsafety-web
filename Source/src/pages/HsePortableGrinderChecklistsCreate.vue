...
const submitForm = async () => {
   formData.portable_grinder_des_1 = 'Grinding machine should be in good and working condition.';
   formData.portable_grinder_des_2 = 'Power cable should be free from damages and connection taken through industrial plug';
   formData.portable_grinder_des_3 = 'A flexible cord should be provided to keep cable free from damage.';
   formData.portable_grinder_des_4 = 'Motor capacity should be marked in RPM';
   formData.portable_grinder_des_5 = 'Dead man switch should be in working condition';
   formData.portable_grinder_des_6 = 'Handle should be provided for better control';
   formData.portable_grinder_des_7 = 'Wheel guard should be properly installed with machine, so that gap between guard and wheel should not be more than 3mm.';
   formData.portable_grinder_des_8 = 'Grinding/cutting wheel should free from defect and rotating capacity should be marked.';
   formData.portable_grinder_des_9 = 'Grinding machine should be double insulated otherwise grounded.';
   formData.portable_grinder_des_10 = 'Always use designated key for removing and changing wheel.';
   formData.portable_grinder_des_11 = 'Machine operated by competent person.';
   formData.portable_grinder_des_12 = 'RPM of wheel should be more than RPM of motor';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_portable_grinder_1 = ishvcomplied1.value;
  formData.is_portable_grinder_2 = ishvcomplied2.value;
  formData.is_portable_grinder_3 = ishvcomplied3.value;
  formData.is_portable_grinder_4 = ishvcomplied4.value;
  formData.is_portable_grinder_5 = ishvcomplied5.value;
  formData.is_portable_grinder_6 = ishvcomplied6.value;
  formData.is_portable_grinder_7 = ishvcomplied7.value;
  formData.is_portable_grinder_8 = ishvcomplied8.value;
  formData.is_portable_grinder_9 = ishvcomplied9.value;
  formData.is_portable_grinder_10 = ishvcomplied10.value;
  formData.is_portable_grinder_11 = ishvcomplied11.value;
  formData.is_portable_grinder_12 = ishvcomplied12.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/portable-grinder-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'portable-grinder-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Portable Grinder</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Portable Grinder
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Grinding machine should be in good and working condition.
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_1" class="w-full" type="text" name="portable_grinder_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_2" class="w-full" type="text" name="portable_grinder_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">A flexible cord should be provided to keep cable free from damage.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_3" class="w-full" type="text" name="portable_grinder_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Motor capacity should be marked in RPM</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_4" class="w-full" type="text" name="portable_grinder_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Dead man switch should be in working condition</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_5" class="w-full" type="text" name="portable_grinder_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Handle should be provided for better control</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_6" class="w-full" type="text" name="portable_grinder_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Wheel guard should be properly installed with machine, so that gap between guard and wheel should not be more than 3mm.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_7" class="w-full" type="text" name="portable_grinder_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Grinding/cutting wheel should free from defect and rotating capacity should be marked.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_8" class="w-full" type="text" name="portable_grinder_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Grinding machine should be double insulated otherwise grounded.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_9" class="w-full" type="text" name="portable_grinder_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Always use designated key for removing and changing wheel.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_10" class="w-full" type="text" name="portable_grinder_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Machine operated by competent person.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_11" class="w-full" type="text" name="portable_grinder_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">RPM of wheel should be more than RPM of motor</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.portable_grinder_remarks_12" class="w-full" type="text" name="portable_grinder_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div>
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/PortableGrinder.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Portable Grinder report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Portable Grinder success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Portable Grinder failed!</div>
