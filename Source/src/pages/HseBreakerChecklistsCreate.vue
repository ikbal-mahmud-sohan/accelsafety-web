...
const submitForm = async () => {
   formData.bar_bending_des_1 = 'Breaker should be in good and working condition';
   formData.bar_bending_des_2 = 'Power cable should be free from damages and connection taken through industrial plug';
   formData.bar_bending_des_3 = 'A flexible cord should be provided to keep cable free from damage';
   formData.bar_bending_des_4 = 'Handle should be provided for better control';
   formData.bar_bending_des_5 = 'Bit should be in good condition and free from defect';
   formData.bar_bending_des_6 = 'Breaker should be double insulated otherwise grounded';
   formData.bar_bending_des_7 = 'Machine operated by competent person';
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/breaker-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-breaker-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Breaker</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Breaker
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Breaker should be in good and working condition
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Bit should be in good condition and free from defect</div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Breaker should be double insulated otherwise grounded</div>
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/Breaker.png" alt="">
          </div>
          <div class="mt-5">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Breaker report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Breaker success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Breaker failed!</div>
