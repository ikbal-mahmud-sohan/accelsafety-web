...
const submitForm = async () => {
   formData.power_distribution_des_1 = 'Physical condition of panel should be good & sound';
   formData.power_distribution_des_2 = 'Panel should be kept on suitable stand';
   formData.power_distribution_des_3 = 'Junction boxes should be free from defects';
   formData.power_distribution_des_4 = 'All connection should be taken through ELCB/RCCB/MCB';
   formData.power_distribution_des_5 = 'Connection socket should be covered with auto lock';
   formData.power_distribution_des_6 = 'Switches and display should be properly covered';
   formData.power_distribution_des_7 = 'A danger signage should be marked.';
   formData.power_distribution_des_8 = 'Panel should be grounded as per IS 3043:1987';
   formData.power_distribution_des_9 = 'Further connection for extension of cable should be taken through male-female connector';
   formData.power_distribution_des_10 = 'In case of flammable atmosphere single length cable shall be use';
   formData.power_distribution_des_11 = 'Canopy should be provided to avoid water getting entered due to rain or any other means.';
   formData.power_distribution_des_12 = 'Rubber mat should be provided to stand during operation';
   formData.power_distribution_des_13 = 'Input power cable should be free from defects';
   formData.power_distribution_des_14 = 'Power input and output cable should be passes through glands';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_power_distribution_1 = ishvcomplied1.value;
  formData.is_power_distribution_2 = ishvcomplied2.value;
  formData.is_power_distribution_3 = ishvcomplied3.value;
  formData.is_power_distribution_4 = ishvcomplied4.value;
  formData.is_power_distribution_5 = ishvcomplied5.value;
  formData.is_power_distribution_6 = ishvcomplied6.value;
  formData.is_power_distribution_7 = ishvcomplied7.value;
  formData.is_power_distribution_8 = ishvcomplied8.value;
  formData.is_power_distribution_9 = ishvcomplied9.value;
  formData.is_power_distribution_10 = ishvcomplied10.value;
  formData.is_power_distribution_11 = ishvcomplied11.value;
  formData.is_power_distribution_12 = ishvcomplied12.value;
  formData.is_power_distribution_13 = ishvcomplied13.value;
  formData.is_power_distribution_14 = ishvcomplied14.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/power-distribution-panel-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-power-distribution-panel-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Power/Sub Distribution Panel</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Power/Sub Distribution Panel
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Physical condition of panel should be good & sound
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_1" class="w-full" type="text" name="power_distribution_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Panel should be kept on suitable stand</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_2" class="w-full" type="text" name="power_distribution_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Junction boxes should be free from defects</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_3" class="w-full" type="text" name="power_distribution_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">All connection should be taken through ELCB/RCCB/MCB</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_4" class="w-full" type="text" name="power_distribution_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Connection socket should be covered with auto lock</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_5" class="w-full" type="text" name="power_distribution_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Switches and display should be properly covered</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_6" class="w-full" type="text" name="power_distribution_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">A danger signage should be marked.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_7" class="w-full" type="text" name="power_distribution_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Panel should be grounded as per IS 3043:1987</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_8" class="w-full" type="text" name="power_distribution_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Further connection for extension of cable should be taken through male-female connector</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_9" class="w-full" type="text" name="power_distribution_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">In case of flammable atmosphere single length cable shall be use</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_10" class="w-full" type="text" name="power_distribution_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Canopy should be provided to avoid water getting entered due to rain or any other means.</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_11" class="w-full" type="text" name="power_distribution_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Rubber mat should be provided to stand during operation</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_12" class="w-full" type="text" name="power_distribution_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Input power cable should be free from defects</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_13" class="w-full" type="text" name="power_distribution_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Power input and output cable should be passes through glands</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.power_distribution_remarks_14" class="w-full" type="text" name="power_distribution_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/SubDistribution.png" alt="">
          </div>
          <div class="mt-5">
            <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <a href="">Power/Sub Distribution Panel</a>
          </li>
          <li
        ...
        >
          ...
          >
            <div>
              When filling out the Power/Sub Distribution Panel report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Power/Sub Distribution Panel success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Power/Sub Distribution Panel failed!</div>
