...
const formDataMonth = reactive({
  name: '',
});
const formDataType = reactive({
  name: '',
});
const formDataInjuryType = reactive({
  name: '',
});
...
const validate = useVuelidate(rules, toRefs(formDataMonth));
const validate1 = useVuelidate(rules, toRefs(formDataType));
const validate2 = useVuelidate(rules, toRefs(formDataInjuryType));
const backendErrors = reactive<{
  ...
  const submitInjuryTypeForm = async () => {
...
function FailedInjuryTypePopUp(){
    const failedEl = document
...
function SuccessInjuryTypePopUp(){
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Add Accident Input</h2>
  </div>
  <div class="grid grid-cols-11 pb-20 mt-5 gap-x-6">
    ...
    <div class="col-span-11 intro-y 2xl:col-span-9">
      ...
      <div class="p-5 mt-5 intro-y box">
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Accident Month
          </div>
          <div class="mt-5">
            <FormInline class="flex-col items-center pt-5 mt-5 xl:flex-row first:mt-0 first:pt-0">
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <FormInput id="crud-form-1" v-model.trim="validate.name.$model" class="w-full" type="text" name="name":class="{ 'border-danger': validate.name.$error,}" placeholder="Ex: January 2024" @keydown.enter="submitForm"/>
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400 flex flex-wrap" >
          <ul v-for="(data, index) in state.accidentMonths" :key="index" class="">
            <li class="p-2">
      ...
      <div class="p-5 mt-5 intro-y box">
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Accident Type
          </div>
          <div class="mt-5">
            <FormInline class="flex-col items-center pt-5 mt-5 xl:flex-row first:mt-0 first:pt-0">
              <FormLabel class="xl:w-64 xl:!mr-10">
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <FormInput id="crud-form-1" v-model.trim="validate1.name.$model" class="w-full" type="text" name="name":class="{ 'border-danger': validate1.name.$error,}" placeholder="Ex: First Aid" @keydown.enter="submitTypeForm"/>
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400 flex flex-wrap" >
          <ul v-for="(data, index) in state.accidentTypess" :key="index" class="">
            <li class="p-2">
              <span class=" inline-block px-4 py-3 bg-gray-100 rounded-sm min-w-52 md:min-w-36 text-center"> 
              {{data.name}}
      ...
      <div class="p-5 mt-5 intro-y box">
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Accident Injury Type
          </div>
          <div class="mt-5">
            <FormInline class="flex-col items-center pt-5 mt-5 xl:flex-row first:mt-0 first:pt-0">
              <FormLabel class="xl:w-64 xl:!mr-10">
              ...
              <div class="flex-1 w-full mt-3 xl:mt-0">
                <FormInput id="crud-form-1" v-model.trim="validate2.name.$model" class="w-full" type="text" name="name":class="{ 'border-danger': validate2.name.$error,}" placeholder="Ex: Cut" @keydown.enter="submitInjuryTypeForm"/>
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400 flex flex-wrap" >
          <ul v-for="(data, index) in state.accidentInjuryTypess" :key="index" class="">
            <li class="p-2">
              <span class=" inline-block px-4 py-3 bg-gray-100 rounded-sm min-w-52 md:min-w-36 text-center"> 
              {{data.name}}
   ...
   <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Accident Month Create success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Accident Month Create failed!</div>
