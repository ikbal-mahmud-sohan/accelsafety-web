    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-safety-power-tools' }">
            <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/11.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-sight-hearin-protection' }">
          <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/Mechanic.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-work-height' }">
          <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/19.Life Buoy.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-compressed-gas-cylinder' }">
          <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/27.Health Check.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-chemical-handling' }">
          <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/28.Don’t Touch.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-hot-work-procedure' }">
          <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/hwp.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-material-handling-procedure' }">
          <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/16.Safety Gloves.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-electrical-safety' }">
          <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/Elecrical Safety.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-1">
        <router-link :to="{ name: 'hse-loto' }">
            <div class="inline-block">
              <img class="w-32 h-32" src="../assets/images/icon/17.Safety Boots.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
