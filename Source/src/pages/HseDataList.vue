    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-4">
        <router-link :to="{ name: 'hse-confined-space' }">
          <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/10.Zero Incidents.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-4">
        <router-link :to="{ name: 'hse-pressure-vessel' }">
          <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/7.Warning.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-4">
        <router-link :to="{ name: 'hse-management-fire-safety-system' }">
          <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/20.Fire Extinguisher.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-4">
        <router-link :to="{ name: 'hse-house-keeping' }">
          <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/29.Workplace Inspection.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-4">
        <router-link :to="{ name: 'hse-personal-protective-equipment' }">
          <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/5.Safety Inspector Female.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-4">
        <router-link :to="{ name: 'hse-job-safety-analysis' }">
          <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/1.Safety.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
    ...
    <div class="w-full lg:w-1/6 md:w-1/3">
      <div class="flex justify-center items-center p-4">
        <router-link :to="{ name: 'accident-investigation-form' }">
          <div class="inline-block">
              <img class="w-32 h-32 transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none" src="../assets/images/icon/6.Safety Checklist.png" alt="">
            </div>
        </router-link>
      </div>
      <div class="py-1">
