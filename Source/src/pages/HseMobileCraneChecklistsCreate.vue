...
const submitForm = async () => {
   formData.mobile_crane_des_1 = 'Physical condition of body should be in sound manner';
   formData.mobile_crane_des_2 = 'No damage in tire (Bolts, crack, cuts & air pressure, etc.)';
   formData.mobile_crane_des_3 = 'Head & tail light and indicators are in working condition';
   formData.mobile_crane_des_4 = 'Side mirror should be in good condition';
   formData.mobile_crane_des_5 = 'Safe work load (SWL) marked.';
   formData.mobile_crane_des_6 = 'Hoist limit switch';
   formData.mobile_crane_des_7 = 'Wire rope free from damage.';
   formData.mobile_crane_des_8 = 'Safety latch in hook.';
   formData.mobile_crane_des_9 = 'Outrigger with spreader mat should be in good and working condition.';
   formData.mobile_crane_des_10 = 'Sprit level should be installed';
   formData.mobile_crane_des_11 = 'Boom condition while full extension (free from damage, crack & jamming, etc.)';
   formData.mobile_crane_des_12 = 'No oil leakage in hydraulic part';
   formData.mobile_crane_des_13 = 'Safe load indicator should be in working state';
   formData.mobile_crane_des_14 = 'Front, reverse and swing horn';
   formData.mobile_crane_des_15 = 'Fire extinguisher in operator cabin';
   formData.mobile_crane_des_16 = 'Operator should have valid and suitable license';
   formData.mobile_crane_des_17 = 'Crane simulator should be in working condition';
   formData.mobile_crane_des_18 = 'First aid kit should be available.';
   formData.mobile_crane_des_19 = 'Crane should be physically good & should have valid TPI';
  formData.checked_by_date = checkedbydate.value;
  formData.reviewed_by_date = reviewedbydate.value;
  formData.date = jcbdate.value;
  formData.is_mobile_crane_1 = ishvcomplied1.value;
  formData.is_mobile_crane_2 = ishvcomplied2.value;
  formData.is_mobile_crane_3 = ishvcomplied3.value;
  formData.is_mobile_crane_4 = ishvcomplied4.value;
  formData.is_mobile_crane_5 = ishvcomplied5.value;
  formData.is_mobile_crane_6 = ishvcomplied6.value;
  formData.is_mobile_crane_7 = ishvcomplied7.value;
  formData.is_mobile_crane_8 = ishvcomplied8.value;
  formData.is_mobile_crane_9 = ishvcomplied9.value;
  formData.is_mobile_crane_10 = ishvcomplied10.value;
  formData.is_mobile_crane_11 = ishvcomplied11.value;
  formData.is_mobile_crane_12 = ishvcomplied12.value;
  formData.is_mobile_crane_13 = ishvcomplied13.value;
  formData.is_mobile_crane_14 = ishvcomplied14.value;
  formData.is_mobile_crane_15 = ishvcomplied15.value;
  formData.is_mobile_crane_16 = ishvcomplied16.value;
  formData.is_mobile_crane_17 = ishvcomplied17.value;
  formData.is_mobile_crane_18 = ishvcomplied18.value;
  formData.is_mobile_crane_19 = ishvcomplied19.value;
    ...
    if (validate.value.$invalid) {
      FailedPopUp();
        ...
        Object.entries(formData).forEach(([key, value]) => {
            ...
            try {
                let  url = config.baseURL+'/api/v1/mobile-crane-checklists';
                ...
                if (response.data !== undefined) {
                    router.push({ name: 'hse-mobile-crane-checklists' });
                }
...
<template>
  <div class="flex items-center mt-8 intro-y">
    <h2 class="mr-auto text-lg font-medium">Mobile Crane</h2>
  </div>
      ...
      <div class="p-0 md:p-5 mt-5 intro-y box">
        ...
        <div class="p-5 border rounded-md border-slate-200/60 dark:border-darkmode-400" >
          <div class="flex items-center pb-5 text-base font-medium border-b border-slate-200/60 dark:border-darkmode-400">
            <Lucide icon="ChevronDown" class="w-4 h-4 mr-2" /> Mobile Crane
          </div>
          <div class="mt-5">
          ...
          <div class="mt-5 border">
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">
                        Physical condition of body should be in sound manner
                      </div>
                    </div>
                </div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_1" class="w-full" type="text" name="mobile_crane_remarks_1" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_2" class="w-full" type="text" name="mobile_crane_remarks_2" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_3" class="w-full" type="text" name="mobile_crane_remarks_3" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              ...
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_4" class="w-full" type="text" name="mobile_crane_remarks_4" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Safe work load (SWL) marked.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_5" class="w-full" type="text" name="mobile_crane_remarks_5" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Hoist limit switch</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_6" class="w-full" type="text" name="mobile_crane_remarks_6" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              ...
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Wire rope free from damage.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_7" class="w-full" type="text" name="mobile_crane_remarks_7" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Safety latch in hook.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_8" class="w-full" type="text" name="mobile_crane_remarks_8" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Outrigger with spreader mat should be in good and working condition.</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_9" class="w-full" type="text" name="mobile_crane_remarks_9" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Sprit level should be installed</div>
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_10" class="w-full" type="text" name="mobile_crane_remarks_10" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Boom condition while full extension (free from damage, crack & jamming, etc.)</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_11" class="w-full" type="text" name="mobile_crane_remarks_11" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">No oil leakage in hydraulic part</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_12" class="w-full" type="text" name="mobile_crane_remarks_12" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Safe load indicator should be in working state</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_13" class="w-full" type="text" name="mobile_crane_remarks_13" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Front, reverse and swing horn</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_14" class="w-full" type="text" name="mobile_crane_remarks_14" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_15" class="w-full" type="text" name="mobile_crane_remarks_15" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_16" class="w-full" type="text" name="mobile_crane_remarks_16" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Crane simulator should be in working condition</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_17" class="w-full" type="text" name="mobile_crane_remarks_17" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_18" class="w-full" type="text" name="mobile_crane_remarks_18" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
              <div class="flex flex-wrap items-center">
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div class="font-medium">Crane should be physically good & should have valid TPI</div>
                    </div>
                </div>
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                ...
                <div class="md:w-1/3 px-2 w-full">
                    <div class="p-4">
                      <div>
                        <FormInput id="crud-form-1" v-model="formData.mobile_crane_remarks_19" class="w-full" type="text" name="mobile_crane_remarks_19" placeholder="Input Remarks"/>
                      </div>
                    </div>
                </div>
              </div> 
          ...
          <div class="mt-5 flex justify-center items-center">
            <img class="w-1/2 " src="../assets/images/additional/Mobile_Crane.png" alt="">
          </div>
          <div class="mt-5">
    ...
    <div class="hidden col-span-2 intro-y 2xl:block">
      <div class="sticky top-0 pt-10">
        ...
        >
          ...
          >
            <div>
              When filling out the Mobile Crane report, be specific and clear with details, using the correct date format and precise descriptions..
            </div>
            <div class="mt-2">
  ...
  <Notification id="success-notification-content" class="flex hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Mobile Crane success!</div>
        </div>
      </Notification>
      ...
      <Notification id="failed-notification-content" class="flex items-center hidden">
        ...
        <div class="ml-4 mr-4">
          <div class="font-medium">Mobile Crane failed!</div>
