...
const location = [
  { name: "Sydney, Australia", latitude: "-33.8688", longitude: "151.2093", security: 7, bcmRisk: 12, ohsRisk: 16 },
  { name: "Dhaka, Bangladesh", latitude: "23.8103", longitude: "90.4125", security: 10, bcmRisk: 12, ohsRisk: 19 },
  { name: "Mumbai, India", latitude: "19.0760", longitude: "72.8777", security: 20, bcmRisk: 27, ohsRisk: 32 },
  { name: "Karachi, Pakistan", latitude: "24.8607", longitude: "67.0011", security: 23, bcmRisk: 31, ohsRisk: 28 },
  { name: "Colombo, Sri Lanka", latitude: "6.9271", longitude: "79.8612", security: 21, bcmRisk: 29, ohsRisk: 32 },
  { name: "Jakarta, Indonesia", latitude: "-6.2088", longitude: "106.8456", security: 19, bcmRisk: 23, ohsRisk: 24 },
  { name: "Kuala Lumpur, Malaysia", latitude: "3.1390", longitude: "101.6869", security: 14, bcmRisk: 20, ohsRisk: 21 },
  { name: "Yangon, Myanmar", latitude: "16.8409", longitude: "96.1735", security: 25, bcmRisk: 39, ohsRisk: 40 },
  { name: "Manila, Philippines", latitude: "14.5995", longitude: "120.9842", security: 26, bcmRisk: 32, ohsRisk: 30 },
  { name: "Singapore, Singapore", latitude: "1.3521", longitude: "103.8198", security: 9, bcmRisk: 15, ohsRisk: 11 },
  { name: "Bangkok, Thailand", latitude: "13.7563", longitude: "100.5018", security: 20, bcmRisk: 28, ohsRisk: 27 },
  { name: "Ho Chi Minh City, Vietnam", latitude: "10.8231", longitude: "106.6297", security: 28, bcmRisk: 37, ohsRisk: 31 },
  { name: "Auckland, New Zealand", latitude: "-36.8485", longitude: "174.7633", security: 11, bcmRisk: 15, ohsRisk: 13 },
];
...
const init: Init = async (initializeMap) => {
  ...
  if (mapInstance) {
    ...
    const apiKey = "b25418ad07c04b7f881c992e2b88fe24";
    ...
    location.map(function (markerElem) {
      ...
      marker.bindTooltip(`
        <div>
          ...
          Security Risk: ${markerElem.security}%<br>
          BCM Risk: ${markerElem.bcmRisk}%<br>
          OHS Risk: ${markerElem.ohsRisk}%
        </div>
      `, {
        ...
        opacity: 0.9, // Opacity of the tooltip
      });
